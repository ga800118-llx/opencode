...
Guai Code 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/opencode/releases) 에서 직접 다운로드하거나 [opencode.ai/download](https://opencode.ai/download) 를 이용하세요.
...
Guai Code 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
Guai Code 설정에 대한 자세한 내용은 [**문서**](https://opencode.ai/docs) 를 참고하세요.

### 기여하기

Guai Code 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### 감사의 글

Guai Code는 업스트림 프로젝트인 OpenCode를 기반으로 합니다. `opencode`는 `opencode-dashboard` 및 `opencode-mobile`을 포함한 업스트림 기술 식별자로 유지됩니다.
