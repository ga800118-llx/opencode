...
Guai Code มีให้ใช้งานเป็นแอปพลิเคชันเดสก์ท็อป ดาวน์โหลดโดยตรงจาก [หน้ารุ่น](https://github.com/anomalyco/opencode/releases) หรือ [opencode.ai/download](https://opencode.ai/download)
...
Guai Code รวมเอเจนต์ในตัวสองตัวที่คุณสามารถสลับได้ด้วยปุ่ม `Tab`
...
สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีกำหนดค่า Guai Code [**ไปที่เอกสารของเรา**](https://opencode.ai/docs)

### การมีส่วนร่วม

หากคุณสนใจที่จะมีส่วนร่วมใน Guai Code โปรดอ่าน [เอกสารการมีส่วนร่วม](./CONTRIBUTING.md) ก่อนส่ง Pull Request

### การระบุแหล่งที่มา

Guai Code สร้างขึ้นบน OpenCode ซึ่งเป็นโปรเจกต์ต้นน้ำ ชื่อ `opencode` ยังคงเป็นตัวระบุทางเทคนิคของต้นน้ำ รวมถึง `opencode-dashboard` และ `opencode-mobile`
