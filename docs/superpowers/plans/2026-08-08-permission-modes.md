...
- [x] **Step 3: Define the shared mode and durable event**
...
- [x] **Step 4: Add and project the session column**
...
- [x] **Step 5: Generate the migration and rerun the test**
...
- [x] **Step 3: Implement the core lifecycle**
...
- [x] **Step 4: Expose the protocol and server handler**
...
- [x] **Step 5: Regenerate the public client**
...
- [x] **Step 6: Rerun core tests and commit**
...
- [x] **Step 1: Write failing Restricted-mode tests**
...
- [x] **Step 3: Add the fixed Restricted overlay**
...
- [x] **Step 2: Run app unit tests and verify failure**
...
- [x] **Step 3: Implement persisted project defaults and task modes**
...
- [x] **Step 4: Carry the mode into task creation**
...
- [x] **Step 5: Test submission and commit**
...
- [x] **Step 1: Write failing mode-request behavior tests**
...
- [x] **Step 2: Run the focused component test and verify failure**
...
- [x] **Step 3: Add the app-owned footer control**
...
- [x] **Step 4: Render in both composer designs**
...
- [x] **Step 5: Add copy, icon, and stories**
...
- [x] **Step 6: Test, typecheck, and commit**
...
- [x] **Step 3: Route old entry points through mode state**
...
- [x] **Step 4: Run app tests, typecheck, and commit**
...
- [x] **Step 1: Run generated-artifact checks**
...
- [x] **Step 4: Verify desktop and mobile interaction**
...
- [x] **Step 5: Audit every specification requirement**
...
- [x] **Step 6: Commit verification fixes or close cleanly**
