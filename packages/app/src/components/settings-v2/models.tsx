...
export const SettingsModelsV2: Component<{ onOpenProviders: () => void }> = (props) => {
  ...
  return (
    <>
      ...
      <div class="settings-v2-tab-body settings-v2-models-page">
        <SettingsModelCenterV2 onOpenProviders={props.onOpenProviders} />

        <section class="settings-v2-section settings-v2-models-visibility">
          <div class="model-center-section-heading model-center-available-heading">
            <h3 class="settings-v2-section-title">{language.t("settings.modelCenter.available.title")}</h3>
          </div>
