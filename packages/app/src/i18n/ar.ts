...
export const dict = {
  ...
  "context.compact.disabled.noSession": "افتح جلسة قبل ضغط السياق.",
  "context.compact.disabled.noUserMessage": "أرسل رسالة قبل ضغط السياق.",
  "context.compact.disabled.working": "انتظر حتى يكتمل الرد الحالي قبل الضغط.",
  "context.compact.disabled.pending": "جارٍ ضغط هذه الجلسة...",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Guai Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Guai Code.",
  ...
  "dialog.server.description": "تبديل خادم Guai Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Guai Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Guai Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Guai Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Guai Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Guai Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Guai Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Guai Code.",
  ...
  "toast.update.description": "نسخة جديدة من Guai Code ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Guai Code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Guai Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Guai Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Guai Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Guai Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Guai Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Guai Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Guai Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Guai Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Guai Code.",
