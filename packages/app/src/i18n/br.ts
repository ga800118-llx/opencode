...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Abra uma sessão antes de compactar o contexto.",
  "context.compact.disabled.noUserMessage": "Envie uma mensagem antes de compactar o contexto.",
  "context.compact.disabled.working": "Aguarde a resposta atual terminar antes de compactar.",
  "context.compact.disabled.pending": "Compactando esta sessão...",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Guai Code",
  "dialog.model.unpaid.addMore.title": "Adicionar mais modelos de provedores populares",
  "dialog.model.unpaid.viewMoreProviders": "Ver mais de 70 provedores adicionais",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Guai Code.",
  ...
  "dialog.server.description": "Trocar para qual servidor Guai Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Guai Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Guai Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Guai Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Guai Code",
  "wsl.onboarding.opencodeReadyIn": "O Guai Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Guai Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Guai Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Guai Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Guai Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Guai Code novamente.",
  ...
  "toast.update.description": "Uma nova versão do Guai Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Guai Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Guai Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "Guai Code Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Guai Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Guai Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Guai Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Guai Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Guai Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Guai Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Guai Code.",
  ...
  "session.header.reveal.containingFolder": "Abrir pasta que contém o item",
