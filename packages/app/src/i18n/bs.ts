...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Otvorite sesiju prije sažimanja konteksta.",
  "context.compact.disabled.noUserMessage": "Pošaljite poruku prije sažimanja konteksta.",
  "context.compact.disabled.working": "Sačekajte da se trenutni odgovor završi prije sažimanja.",
  "context.compact.disabled.pending": "Sažimanje ove sesije...",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Guai Code-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Guai Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Guai Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Guai Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Guai Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Guai Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Guai Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Guai Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Guai Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Guai Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Guai Code.",
  ...
  "toast.update.description": "Nova verzija Guai Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Guai Code timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Guai Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Guai Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Guai Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Guai Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Guai Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Guai Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Guai Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Guai Code-a.",
