...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Åbn en session, før konteksten komprimeres.",
  "context.compact.disabled.noUserMessage": "Send en besked, før konteksten komprimeres.",
  "context.compact.disabled.working": "Vent på, at det aktuelle svar afsluttes, før der komprimeres.",
  "context.compact.disabled.pending": "Komprimerer denne session...",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Guai Code.",
  ...
  "dialog.server.description": "Skift hvilken Guai Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Guai Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Guai Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Guai Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Guai Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Guai Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Guai Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Guai Code igen.",
  ...
  "toast.update.description": "En ny version af Guai Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Guai Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Guai Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Guai Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Guai Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Guai Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Guai Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Guai Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Guai Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Guai Code.",
  ...
  "session.header.reveal.containingFolder": "Åbn mappen, der indeholder filen",
