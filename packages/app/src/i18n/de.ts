...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Öffne eine Sitzung, bevor du den Kontext komprimierst.",
  "context.compact.disabled.noUserMessage": "Sende eine Nachricht, bevor du den Kontext komprimierst.",
  "context.compact.disabled.working": "Warte, bis die aktuelle Antwort abgeschlossen ist.",
  "context.compact.disabled.pending": "Sitzung wird komprimiert...",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Guai Code zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Guai Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Guai Code zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Guai Code-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Guai Code wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Guai Code in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Guai Code wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Guai Code in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Guai Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Guai Code aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Guai Code ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Guai Code ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Guai Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Guai Code installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Guai Code einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Guai Code konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Guai Code erneut.",
  ...
  "toast.update.description": "Eine neue Version von Guai Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Guai Code-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Guai Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Guai Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Guai Code ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Guai Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Guai Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Guai Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Guai Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Guai Code.",
