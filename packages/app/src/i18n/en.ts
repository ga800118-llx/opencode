...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Open a session before compacting context.",
  "context.compact.disabled.noUserMessage": "Send a message before compacting context.",
  "context.compact.disabled.working": "Wait for the current response to finish before compacting.",
  "context.compact.disabled.pending": "Compacting this session...",
