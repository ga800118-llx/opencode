...
export const dict = {
  ...
  "settings.skills.filter.label": "Filter Skills by status",
  "settings.skills.filter.all": "All",
  "settings.skills.filter.active": "Active",
  "settings.skills.filter.disabled": "Disabled",
  "settings.skills.filter.shadowed": "Shadowed",
  "settings.skills.source.builtin": "Built-in",
  "settings.skills.source.remote": "Remote",
  "settings.skills.source.plugin": "Plugin",
  "settings.skills.source.external": "Shared directory",
  "settings.skills.source.project": "Project",
  "settings.skills.source.global": "Global",
  "settings.skills.source.label": "Source: {{value}}",
  "settings.skills.scope.project": "Project",
  "settings.skills.scope.global": "Global",
  "settings.skills.scope.label": "Scope: {{value}}",
  "settings.skills.status.active": "Active",
  "settings.skills.status.disabled": "Disabled",
  "settings.skills.status.shadowed": "Shadowed",
  "settings.skills.status.label": "Status: {{value}}",
  "settings.skills.deleteBlocked.builtin": "Built-in skill",
  "settings.skills.deleteBlocked.remote": "Remote source",
  "settings.skills.deleteBlocked.plugin": "Managed by plugin",
  "settings.skills.deleteBlocked.shared": "Shared with other agent applications",
  "settings.skills.deleteBlocked.unsafe": "Path could not be verified",
  "settings.skills.path.label": "Path or URL: {{value}}",
  "settings.skills.locationRequired": "Open a project to manage its Skills.",
  ...
  "settings.skills.delete.cancel": "Cancel",
  "settings.skills.delete.action": "Delete {{name}}",
  "settings.skills.delete.actionButton": "Delete",
  "settings.skills.delete.deleting": "Deleting...",
  "settings.skills.enable.success": "Enabled {{name}}",
  "settings.skills.enable.failure": "Could not enable {{name}}.",
  "settings.skills.disable.success": "Disabled {{name}}",
  "settings.skills.disable.failure": "Could not disable {{name}}.",
  "settings.skills.delete.success": "Deleted {{name}}",
  "settings.skills.delete.failure": "Could not delete {{name}}.",
  ...
  "command.category.session": "Tasks",
  ...
  "command.session.previous": "Previous task",
  "command.session.next": "Next task",
  "command.session.previous.unseen": "Previous unread task",
  "command.session.next.unseen": "Next unread task",
  "command.session.archive": "Archive task",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Guai Code.",
  ...
  "dialog.server.description": "Switch which Guai Code server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Guai Code",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Guai Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Guai Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Guai Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Guai Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Guai Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Guai Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Guai Code.",
  ...
  "toast.update.description": "A new version of Guai Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Guai Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Guai Code does not support MCP authentication yet.',
  ...
  "notification.action.goToSession": "Go to task",
  ...
  "home.sessions.search.placeholder": "Search tasks",
  ...
  "sidebar.nav.projectsAndSessions": "Projects and tasks",
  "sidebar.settings": "Settings",
  "sidebar.help": "Help",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "Guai Code includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent tasks",
  "sidebar.project.viewAllSessions": "View all tasks",
  ...
  "app.name.desktop": "Agent Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Guai Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Guai Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Guai Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Guai Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Guai Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Guai Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Guai Code.",
