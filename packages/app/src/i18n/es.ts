...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Abre una sesión antes de compactar el contexto.",
  "context.compact.disabled.noUserMessage": "Envía un mensaje antes de compactar el contexto.",
  "context.compact.disabled.working": "Espera a que termine la respuesta actual antes de compactar.",
  "context.compact.disabled.pending": "Compactando esta sesión...",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Guai Code.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Guai Code se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Guai Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Guai Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Guai Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Guai Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Guai Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Guai Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Guai Code.",
  ...
  "toast.update.description": "Una nueva versión de Guai Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Guai Code",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Guai Code no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Guai Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Guai Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Guai Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Guai Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Guai Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Guai Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Guai Code.",
