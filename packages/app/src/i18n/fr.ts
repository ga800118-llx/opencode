...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Ouvrez une session avant de compacter le contexte.",
  "context.compact.disabled.noUserMessage": "Envoyez un message avant de compacter le contexte.",
  "context.compact.disabled.working": "Attendez la fin de la réponse en cours avant de compacter.",
  "context.compact.disabled.pending": "Compactage de cette session...",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Guai Code.",
  ...
  "dialog.server.description": "Changez le serveur Guai Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Guai Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Guai Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Guai Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Guai Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Guai Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Guai Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Guai Code.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Guai Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Guai Code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Guai Code ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Guai Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Guai Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Guai Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Guai Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Guai Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Guai Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Guai Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Guai Code.",
