...
export const dict = {
  ...
  "context.compact.disabled.noSession": "コンテキストを圧縮する前にセッションを開いてください。",
  "context.compact.disabled.noUserMessage": "コンテキストを圧縮する前にメッセージを送信してください。",
  "context.compact.disabled.working": "現在の応答が完了してから圧縮してください。",
  "context.compact.disabled.pending": "このセッションを圧縮しています...",
  ...
  "dialog.model.unpaid.freeModels.title": "Guai Codeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Guai Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してGuai Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Guai Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するGuai Codeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Guai Codeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のGuai Codeを確認中...",
  "wsl.onboarding.updatingOpencode": "Guai Codeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のGuai Codeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のGuai Codeを更新してください。",
  "wsl.onboarding.updateOpencode": "Guai Codeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のGuai Codeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Guai Codeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にGuai Codeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Guai Codeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Codeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Guai CodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Guai Codeをもう一度開いてください。",
  ...
  "toast.update.description": "Guai Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをGuai Codeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Guai CodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Guai Codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でGuai Codeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Guai Codeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのGuai Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Guai Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Guai Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Guai Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Guai Code は最新バージョンです。",
