...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Åpne en økt før du komprimerer konteksten.",
  "context.compact.disabled.noUserMessage": "Send en melding før du komprimerer konteksten.",
  "context.compact.disabled.working": "Vent til gjeldende svar er ferdig før du komprimerer.",
  "context.compact.disabled.pending": "Komprimerer denne økten...",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Guai Code.",
  ...
  "dialog.server.description": "Bytt hvilken Guai Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Guai Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Guai Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Guai Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Guai Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Guai Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Guai Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Guai Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Guai Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Guai Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Guai Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Guai Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Guai Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Guai Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Guai Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Guai Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Guai Code på nytt.",
