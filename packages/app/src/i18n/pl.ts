...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Otwórz sesję przed kompaktowaniem kontekstu.",
  "context.compact.disabled.noUserMessage": "Wyślij wiadomość przed kompaktowaniem kontekstu.",
  "context.compact.disabled.working": "Poczekaj na zakończenie bieżącej odpowiedzi przed kompaktowaniem.",
  "context.compact.disabled.pending": "Trwa kompaktowanie tej sesji...",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Guai Code.",
  ...
  "dialog.server.description": "Przełącz serwer Guai Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Guai Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Guai Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Guai Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Guai Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Guai Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Guai Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Guai Code.",
  ...
  "toast.update.description": "Nowa wersja Guai Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Guai Code",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Guai Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Guai Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Guai Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Guai Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Guai Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Guai Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Guai Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Guai Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Guai Code.",
