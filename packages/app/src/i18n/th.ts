...
export const dict = {
  ...
  "context.compact.disabled.noSession": "เปิดเซสชันก่อนบีบอัดบริบท",
  "context.compact.disabled.noUserMessage": "ส่งข้อความก่อนบีบอัดบริบท",
  "context.compact.disabled.working": "รอให้การตอบกลับปัจจุบันเสร็จสิ้นก่อนบีบอัด",
  "context.compact.disabled.pending": "กำลังบีบอัดเซสชันนี้...",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Guai Code",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Guai Code",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Guai Code",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Guai Code",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Guai Code ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Guai Code ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Guai Code ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Guai Code ใน {{distro}}.",
  "wsl.onboarding.updateOpencode": "อัปเดต Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.opencodeReady": "Guai Code พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Guai Code ใน {{distro}}.",
  "wsl.onboarding.installOpencode": "ติดตั้ง Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Guai Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Guai Code จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Guai Code ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Guai Code อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Guai Code ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Guai Code",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Guai Code ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Guai Code รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Guai Code ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Guai Code",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Guai Code มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Guai Code ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Guai Code มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Guai Code เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Guai Code เวอร์ชันล่าสุด",
  ...
  "session.header.reveal.containingFolder": "เปิดโฟลเดอร์ที่มีไฟล์อยู่",
