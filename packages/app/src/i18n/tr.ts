...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Bağlamı sıkıştırmadan önce bir oturum açın.",
  "context.compact.disabled.noUserMessage": "Bağlamı sıkıştırmadan önce bir mesaj gönderin.",
  "context.compact.disabled.working": "Sıkıştırmadan önce geçerli yanıtın tamamlanmasını bekleyin.",
  "context.compact.disabled.pending": "Bu oturum sıkıştırılıyor...",
  ...
  "dialog.model.unpaid.freeModels.title": "Guai Code tarafından sunulan ücretsiz modeller",
  "dialog.model.unpaid.addMore.title": "Popüler sağlayıcılardan daha fazla model ekleyin",
  "dialog.model.unpaid.viewMoreProviders": "70'ten fazla ek sağlayıcıyı görüntüle",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Guai Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Guai Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Guai Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Guai Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Guai Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Guai Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Guai Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Guai Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Guai Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Guai Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Guai Code hazır.",
  "wsl.onboarding.opencodeReady": "Guai Code hazır.",
  "wsl.onboarding.installOpencodeIn": "Guai Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Guai Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Guai Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Guai Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Guai Code'u tekrar açın.",
  ...
  "toast.update.description": "Guai Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Guai Code ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Guai Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Guai Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "Guai Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Guai Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Guai Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Guai Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Guai Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Guai Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Guai Code'un en son sürümünü kullanıyorsunuz.",
