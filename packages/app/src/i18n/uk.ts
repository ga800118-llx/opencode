...
export const dict = {
  ...
  "context.compact.disabled.noSession": "Відкрийте сеанс перед стисканням контексту.",
  "context.compact.disabled.noUserMessage": "Надішліть повідомлення перед стисканням контексту.",
  "context.compact.disabled.working": "Дочекайтеся завершення поточної відповіді перед стисканням.",
  "context.compact.disabled.pending": "Стискання цього сеансу...",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Guai Code",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Guai Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Guai Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Guai Code.",
  ...
  "dialog.server.description": "Перемкніть сервер Guai Code, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Guai Code у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Guai Code у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Guai Code у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Guai Code",
  "wsl.onboarding.opencodeReadyIn": "Guai Code готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Guai Code готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Guai Code у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Guai Code не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Guai Code потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Guai Code не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Guai Code.",
  ...
  "toast.update.description": "Нова версія Guai Code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Guai Code",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Guai Code ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Guai Code містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Guai Code всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Guai Code",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Guai Code на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Guai Code використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Guai Code.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Guai Code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Guai Code.",
