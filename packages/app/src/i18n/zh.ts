...
export const dict = {
  ...
  "settings.skills.filter.label": "按状态筛选 Skill",
  "settings.skills.filter.all": "全部",
  "settings.skills.filter.active": "已生效",
  "settings.skills.filter.disabled": "已禁用",
  "settings.skills.filter.shadowed": "被覆盖",
  "settings.skills.source.builtin": "内置",
  "settings.skills.source.remote": "远程",
  "settings.skills.source.plugin": "插件",
  "settings.skills.source.external": "共享目录",
  "settings.skills.source.project": "项目",
  "settings.skills.source.global": "全局",
  "settings.skills.source.label": "来源：{{value}}",
  "settings.skills.scope.project": "项目",
  "settings.skills.scope.global": "全局",
  "settings.skills.scope.label": "作用域：{{value}}",
  "settings.skills.status.active": "已生效",
  "settings.skills.status.disabled": "已禁用",
  "settings.skills.status.shadowed": "被覆盖",
  "settings.skills.status.label": "状态：{{value}}",
  "settings.skills.deleteBlocked.builtin": "内置 Skill",
  "settings.skills.deleteBlocked.remote": "远程来源",
  "settings.skills.deleteBlocked.plugin": "由插件管理",
  "settings.skills.deleteBlocked.shared": "与其他智能体应用共享",
  "settings.skills.deleteBlocked.unsafe": "无法验证路径",
  "settings.skills.path.label": "路径或网址：{{value}}",
  "settings.skills.locationRequired": "请先打开一个项目以管理其 Skill。",
  "settings.skills.loading": "正在加载 Skill...",
  "settings.skills.empty": "尚未安装 Skill。",
  "settings.skills.noMatches": "没有符合当前搜索和筛选条件的 Skill。",
  "settings.skills.load.failure": "无法加载 Skill。",
  "settings.skills.refresh": "刷新 Skill",
  "settings.skills.refresh.failure": "无法刷新 Skill，当前显示的是上次成功加载的结果。",
  "settings.skills.enable.label": "启用 {{name}}",
  "settings.skills.disable.label": "禁用 {{name}}",
  ...
  "settings.skills.delete.action": "删除 {{name}}",
  "settings.skills.delete.actionButton": "删除",
  "settings.skills.delete.deleting": "正在删除...",
  "settings.skills.enable.success": "已启用 {{name}}",
  "settings.skills.enable.failure": "无法启用 {{name}}。",
  "settings.skills.disable.success": "已禁用 {{name}}",
  "settings.skills.disable.failure": "无法禁用 {{name}}。",
  "settings.skills.delete.success": "已删除 {{name}}",
  "settings.skills.delete.failure": "无法删除 {{name}}。",
  ...
  "command.session.previous": "上一个任务",
  "command.session.next": "下一个任务",
  "command.session.previous.unseen": "上一个未读任务",
  "command.session.next.unseen": "下一个未读任务",
  "command.session.archive": "归档任务",
  ...
  "context.compact.disabled.noSession": "请先打开一个会话，再精简上下文。",
  "context.compact.disabled.noUserMessage": "请先发送一条消息，再精简上下文。",
  "context.compact.disabled.working": "请等待当前回答完成后再精简。",
  "context.compact.disabled.pending": "正在精简此会话...",
  ...
  "dialog.model.unpaid.freeModels.title": "Guai Code 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Guai Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Guai Code 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Guai Code 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Guai Code...",
  "wsl.onboarding.updatingOpencode": "正在更新 Guai Code...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Guai Code...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Guai Code。",
  "wsl.onboarding.updateOpencode": "更新 Guai Code",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Guai Code 已就绪。",
  "wsl.onboarding.opencodeReady": "Guai Code 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Guai Code。",
  "wsl.onboarding.installOpencode": "安装 Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Guai Code",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Guai Code 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Guai Code 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Guai Code。",
  ...
  "toast.update.description": "Guai Code 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Guai Code 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Guai Code 暂不支持 MCP 认证。',
  ...
  "notification.action.goToSession": "前往任务",
  ...
  "home.sessions.search.placeholder": "搜索任务",
  "home.sessions.search.placeholder.scoped": "在 {{scope}} 中搜索任务",
  "home.sessions.search.sessions": "任务",
  "home.sessions.search.noResults": "未找到与 {{query}} 相关的任务",
  "home.sessions.empty": "暂无任务",
  "home.sessions.empty.description": "创建一个任务以开始。",
  ...
  "sidebar.nav.projectsAndSessions": "项目和任务",
  "sidebar.settings": "设置",
  "sidebar.help": "帮助",
  "sidebar.workspaces.enable": "启用工作区",
  "sidebar.workspaces.disable": "禁用工作区",
  "sidebar.gettingStarted.title": "入门",
  "sidebar.gettingStarted.line1": "Guai Code 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "连接任意提供商即可使用更多模型，如 Claude、GPT、Gemini 等。",
  "sidebar.project.recentSessions": "最近任务",
  "sidebar.project.viewAllSessions": "查看全部任务",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Guai Code 服务器。",
  ...
  "settings.general.row.language.description": "更改 Guai Code 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Guai Code 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Guai Code 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Guai Code 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Guai Code 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Guai Code。",
