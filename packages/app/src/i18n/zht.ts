...
export const dict = {
  ...
  "settings.skills.count": "已安裝 {{count}} 個",
  "settings.skills.search": "搜尋 Skill",
  "settings.skills.filter.label": "依狀態篩選 Skill",
  "settings.skills.filter.all": "全部",
  "settings.skills.filter.active": "已生效",
  "settings.skills.filter.disabled": "已停用",
  "settings.skills.filter.shadowed": "被覆蓋",
  "settings.skills.source.builtin": "內建",
  "settings.skills.source.remote": "遠端",
  "settings.skills.source.plugin": "外掛",
  "settings.skills.source.external": "共享目錄",
  "settings.skills.source.project": "專案",
  "settings.skills.source.global": "全域",
  "settings.skills.source.label": "來源：{{value}}",
  "settings.skills.scope.project": "專案",
  "settings.skills.scope.global": "全域",
  "settings.skills.scope.label": "範圍：{{value}}",
  "settings.skills.status.active": "已生效",
  "settings.skills.status.disabled": "已停用",
  "settings.skills.status.shadowed": "被覆蓋",
  "settings.skills.status.label": "狀態：{{value}}",
  "settings.skills.deleteBlocked.builtin": "內建 Skill",
  "settings.skills.deleteBlocked.remote": "遠端來源",
  "settings.skills.deleteBlocked.plugin": "由外掛管理",
  "settings.skills.deleteBlocked.shared": "與其他智慧代理應用程式共享",
  "settings.skills.deleteBlocked.unsafe": "無法驗證路徑",
  "settings.skills.path.label": "路徑或網址：{{value}}",
  "settings.skills.locationRequired": "請先開啟一個專案以管理其 Skill。",
  "settings.skills.loading": "正在載入 Skill...",
  ...
  "settings.skills.delete.action": "刪除 {{name}}",
  "settings.skills.delete.actionButton": "刪除",
  "settings.skills.delete.deleting": "正在刪除...",
  "settings.skills.enable.success": "已啟用 {{name}}",
  "settings.skills.enable.failure": "無法啟用 {{name}}。",
  "settings.skills.disable.success": "已停用 {{name}}",
  "settings.skills.disable.failure": "無法停用 {{name}}。",
  "settings.skills.delete.success": "已刪除 {{name}}",
  "settings.skills.delete.failure": "無法刪除 {{name}}。",
  ...
  "context.compact.disabled.noSession": "請先開啟工作階段，再精簡上下文。",
  "context.compact.disabled.noUserMessage": "請先傳送一則訊息，再精簡上下文。",
  "context.compact.disabled.working": "請等待目前回覆完成後再精簡。",
  "context.compact.disabled.pending": "正在精簡此工作階段...",
  ...
  "dialog.model.unpaid.freeModels.title": "Guai Code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Guai Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Guai Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Guai Code 中使用 {{provider}} 模型。",
  ...
  "prompt.menu.shellCommand": "Shell 指令",
  ...
  "dialog.server.description": "切換此應用程式連線的 Guai Code 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Guai Code...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Guai Code...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Guai Code 已就緒。",
  "wsl.onboarding.opencodeReady": "Guai Code 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Guai Code。",
  "wsl.onboarding.installOpencode": "安裝 Guai Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Guai Code",
  ...
  "wsl.onboarding.wslUnavailable.description": "Guai Code 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Guai Code。",
  ...
  "toast.update.description": "Guai Code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Guai Code 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Guai Code 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Guai Code 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Guai Code 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Guai Code 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Guai Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Guai Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Guai Code 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Guai Code 啟動時自動檢查更新",
