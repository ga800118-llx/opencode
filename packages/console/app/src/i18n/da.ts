...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | Guai Code",
  ...
  "app.meta.description": "Guai Code - Den open source kodningsagent.",

  "home.title": "Guai Code | Den open source AI-kodningsagent",

  "temp.title": "Guai Code | AI-kodningsagent bygget til terminalen",
  ...
  "temp.screenshot.caption": "Guai Code TUI med tokyonight-temaet",
  "temp.screenshot.alt": "Guai Code TUI med tokyonight-temaet",
  ...
  "home.what.title": "Hvad er Guai Code?",
  "home.what.body":
    "Guai Code er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges Guai Code af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "Guai Code gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er Guai Code?",
  "home.faq.a1":
    "Guai Code er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg Guai Code?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge Guai Code?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Guai Code kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men Guai Code virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med Guai Code?",
  "home.faq.a4.p1":
    "Ja. Guai Code understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge Guai Code i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! Guai Code er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster Guai Code?",
  "home.faq.a6":
    "Guai Code er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er Guai Code open source?",
  "home.faq.a8.p1": "Ja, Guai Code er fuldt open source. Kildekoden er offentlig på",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med Guai Code, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg Guai Code",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start Guai Code og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til Guai Code-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en Guai Code Gateway API-nøgle",
  ...
  "download.meta.description": "Download Guai Code til macOS, Windows og Linux",
  "download.hero.title": "Download Guai Code Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde Guai Code til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer Guai Code med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Guai Code er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom Guai Code fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i Guai Code.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Guai Code | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt Guai Code for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "Guai Code fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er Guai Code Enterprise?",
  "enterprise.faq.a1":
    "Guai Code Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Guai Code Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. Guai Code gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med Guai Code Enterprise?",
  "enterprise.faq.a4":
    "Ja. Guai Code gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "Guai Code | Brand",
  "brand.meta.description": "Guai Code brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med Guai Code-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "Guai Code | Changelog",
  "changelog.meta.description": "Guai Code versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til Guai Code",
