export const dict = {
  ...
  "notFound.title": "Not Found | Guai Code",
  ...
  "app.meta.description": "Guai Code - The open source coding agent.",

  "home.title": "Guai Code | The open source AI coding agent",

  "temp.title": "Guai Code | AI coding agent built for the terminal",
  ...
  "temp.screenshot.caption": "Guai Code TUI with the tokyonight theme",
  "temp.screenshot.alt": "Guai Code TUI with tokyonight theme",
  ...
  "home.what.title": "What is Guai Code?",
  "home.what.body": "Guai Code is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Guai Code is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Guai Code does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Guai Code?",
  "home.faq.a1":
    "Guai Code is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Guai Code?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Guai Code?",
  "home.faq.a3.p1":
    "Not necessarily, Guai Code comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Guai Code also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Guai Code?",
  "home.faq.a4.p1":
    "Yes, Guai Code supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Guai Code in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Guai Code is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Guai Code cost?",
  "home.faq.a6":
    "Guai Code is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Guai Code open source?",
  "home.faq.a8.p1": "Yes, Guai Code is fully open source. The source code is public on",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with Guai Code whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select Guai Code",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start Guai Code and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing Guai Code services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create a Guai Code Gateway API key",
  ...
  "download.meta.description": "Download Guai Code for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Guai Code to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Guai Code works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Guai Code is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Guai Code works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Guai Code.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Guai Code | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Guai Code for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Guai Code operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Guai Code Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with Guai Code Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Guai Code by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Guai Code Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.meta.description": "Guai Code brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Guai Code brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Guai Code | Changelog",
  "changelog.meta.description": "Guai Code release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Guai Code",
