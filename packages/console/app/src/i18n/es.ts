...
export const dict = {
  ...
  "notFound.title": "No encontrado | Guai Code",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Guai Code logo claro",
  "notFound.logoDarkAlt": "Guai Code logo oscuro",
  ...
  "app.meta.description": "Guai Code - El agente de codificación de código abierto.",

  "home.title": "Guai Code | El agente de codificación IA de código abierto",

  "temp.title": "Guai Code | Agente de codificación IA creado para la terminal",
  ...
  "temp.screenshot.caption": "Guai Code TUI con el tema tokyonight",
  "temp.screenshot.alt": "Guai Code TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de Guai Code claro",
  "temp.logoDarkAlt": "logo de Guai Code oscuro",
  ...
  "home.what.title": "¿Qué es Guai Code?",
  "home.what.body":
    "Guai Code es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, Guai Code es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "Guai Code no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es Guai Code?",
  "home.faq.a1":
    "Guai Code es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso Guai Code?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar Guai Code?",
  "home.faq.a3.p1":
    "No necesariamente, Guai Code viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, Guai Code también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con Guai Code?",
  "home.faq.a4.p1":
    "Sí, Guai Code soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar Guai Code en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! Guai Code ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta Guai Code?",
  "home.faq.a6":
    "Guai Code es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es Guai Code de código abierto?",
  "home.faq.a8.p1": "Sí, Guai Code es totalmente de código abierto. El código fuente es público en",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con Guai Code cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona Guai Code",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia Guai Code y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de Guai Code.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de Guai Code Gateway",
  ...
  "download.title": "Guai Code | Descargar",
  "download.meta.description": "Descarga Guai Code para macOS, Windows y Linux",
  "download.hero.title": "Descargar Guai Code Desktop",
  ...
  "download.section.extensions": "Extensiones Guai Code",
  "download.section.integrations": "Integraciones Guai Code",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar Guai Code a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", Guai Code funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Guai Code es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque Guai Code funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en Guai Code.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "Guai Code | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a Guai Code para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "Guai Code opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es Guai Code Enterprise?",
  "enterprise.faq.a1":
    "Guai Code Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con Guai Code Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. Guai Code por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con Guai Code Enterprise?",
  "enterprise.faq.a4":
    "Sí. Guai Code no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "Guai Code | Marca",
  "brand.meta.description": "Guías de marca de Guai Code",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca Guai Code.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "Guai Code | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de Guai Code",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para Guai Code",
