...
export const dict = {
  ...
  "notFound.title": "Non trovato | Guai Code",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di Guai Code",
  "notFound.logoDarkAlt": "logo scuro di Guai Code",
  ...
  "app.meta.description": "Guai Code - L'agente di programmazione open source.",

  "home.title": "Guai Code | L'agente di coding IA open source",

  "temp.title": "Guai Code | Agente di coding IA costruito per il terminale",
  ...
  "temp.screenshot.caption": "Guai Code TUI con il tema tokyonight",
  "temp.screenshot.alt": "Guai Code TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di Guai Code",
  "temp.logoDarkAlt": "logo scuro di Guai Code",
  ...
  "home.what.title": "Che cos'è Guai Code?",
  "home.what.body": "Guai Code è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Guai Code è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Guai Code non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è Guai Code?",
  "home.faq.a1":
    "Guai Code è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Guai Code?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Guai Code?",
  "home.faq.a3.p1":
    "Non necessariamente: Guai Code include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Guai Code funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Guai Code?",
  "home.faq.a4.p1":
    "Sì, Guai Code supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Guai Code solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! Guai Code ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Guai Code?",
  "home.faq.a6":
    "Guai Code è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Guai Code è open source?",
  "home.faq.a8.p1": "Sì, Guai Code è completamente open source. Il codice sorgente è pubblico su",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con Guai Code quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona Guai Code",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia Guai Code ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi Guai Code.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API Guai Code Gateway",
  ...
  "download.title": "Guai Code | Download",
  "download.meta.description": "Scarica Guai Code per macOS, Windows e Linux",
  "download.hero.title": "Scarica Guai Code Desktop",
  ...
  "download.section.extensions": "Guai Code Extensions",
  "download.section.integrations": "Guai Code Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare Guai Code a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", Guai Code funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "Guai Code è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre Guai Code funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in Guai Code.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "Guai Code | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Guai Code per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "Guai Code opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è Guai Code Enterprise?",
  "enterprise.faq.a1":
    "Guai Code Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con Guai Code Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Guai Code per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con Guai Code Enterprise?",
  "enterprise.faq.a4":
    "Sì. Guai Code non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Guai Code | Brand",
  "brand.meta.description": "Linee guida del brand Guai Code",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Guai Code.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "Guai Code | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog Guai Code",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a Guai Code",
