...
export const dict = {
  ...
  "notFound.title": "找不到頁面 | Guai Code",
  "notFound.heading": "404 - 找不到頁面",
  "notFound.home": "首頁",
  "notFound.docs": "文件",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Guai Code 淺色標誌",
  "notFound.logoDarkAlt": "Guai Code 深色標誌",
  ...
  "app.meta.description": "Guai Code - 開源編碼代理。",

  "home.title": "Guai Code | 開源 AI 編碼代理",

  "temp.title": "Guai Code | 專為終端打造的 AI 編碼代理",
  ...
  "temp.screenshot.caption": "使用 tokyonight 主題的 Guai Code TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 Guai Code TUI",
  "temp.logoLightAlt": "Guai Code 淺色標誌",
  "temp.logoDarkAlt": "Guai Code 深色標誌",
  ...
  "home.what.title": "什麼是 Guai Code？",
  "home.what.body": "Guai Code 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，Guai Code 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "Guai Code 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 Guai Code？",
  "home.faq.a1":
    "Guai Code 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 Guai Code？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 Guai Code 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。Guai Code 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，你可以透過建立",
  "home.faq.a3.p2.afterZen": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 Guai Code 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。Guai Code 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "Guai Code 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！Guai Code 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "Guai Code 價格如何？",
  "home.faq.a6": "Guai Code 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "Guai Code 是開源的嗎？",
  "home.faq.a8.p1": "是的，Guai Code 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 Guai Code 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 Guai Code",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 Guai Code 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 Guai Code 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 Guai Code 閘道器 API 金鑰",
  ...
  "download.title": "Guai Code | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 Guai Code",
  "download.hero.title": "下載 Guai Code 桌面版",
  "download.hero.subtitle": "適用於 macOS、Windows 與 Linux 的 Beta 版現已提供",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "Guai Code 終端",
  "download.section.desktop": "Guai Code 桌面版",
  "download.section.extensions": "Guai Code 擴充功能",
  "download.section.integrations": "Guai Code 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 Guai Code 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免費。我們也推薦使用",
  "download.faq.a3.afterZen": "，但 Guai Code 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "Guai Code 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 Guai Code 支援任何模型供應商，但我們建議使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "你的資料與資訊只會在你於 Guai Code 中建立可分享連結時被儲存。",
  "download.faq.a6.p2.beforeShare": "了解更多關於",
  "download.faq.a6.shareLink": "分享頁面",

  "enterprise.title": "Guai Code | 面向組織的企業解決方案",
  "enterprise.meta.description": "聯絡 Guai Code 取得企業解決方案",
  "enterprise.hero.title": "你的程式碼屬於你",
  "enterprise.hero.body1":
    "Guai Code 在你的組織內部安全運作，不會儲存任何資料或上下文，也沒有授權限制或所有權主張。你可以先與團隊進行試用，然後透過與你的 SSO 與內部 AI 閘道器整合，將其部署到整個組織。",
  ...
  "enterprise.faq.q1": "什麼是 Guai Code Enterprise？",
  "enterprise.faq.a1":
    "Guai Code Enterprise 適用於希望確保程式碼與資料絕不離開自己基礎設施的組織。透過中央化設定，它可與你的 SSO 與內部 AI 閘道器整合，以達成此目標。",
  "enterprise.faq.q2": "如何開始使用 Guai Code Enterprise？",
  "enterprise.faq.a2":
    "只要先以團隊的內部試用開始。Guai Code 預設不會儲存你的程式碼或上下文資料，所以上手非常容易。之後聯絡我們，討論定價與完整實作方案。",
  "enterprise.faq.q3": "企業定價是如何進行的？",
  "enterprise.faq.a3":
    "我們提供按席位的企業定價。如果你有自己的 LLM 閘道器，我們不會對使用的 token 另外收費。更多詳情，請聯絡我們以獲得依據組織需求的客製報價。",
  "enterprise.faq.q4": "我的資料在 Guai Code Enterprise 中是安全的嗎？",
  "enterprise.faq.a4":
    "是的。Guai Code 不會儲存你的程式碼或上下文資料。所有處理都會在本地或透過直接呼叫你的 AI 供應商 API 完成。透過中央化設定與 SSO 整合，你的資料會安全保留在組織的基礎設施內部。",

  "brand.title": "Guai Code | 品牌",
  "brand.meta.description": "Guai Code 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "協助你使用 Guai Code 品牌的資源與素材。",
  "brand.downloadAll": "下載所有素材",

  "changelog.title": "Guai Code | 更新日誌",
  "changelog.meta.description": "Guai Code 發布說明與更新日誌",
  "changelog.hero.title": "更新日誌",
  "changelog.hero.subtitle": "Guai Code 的新更新與改善",
