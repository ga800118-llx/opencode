      ...
      <header data-component="header">
        <A href={language.route("/")} data-component="header-logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="179" height="32" viewBox="0 0 179 32" fill="none">
            ...
            <path d="M0 0H24V6H0V0Z" fill="#CDCDCD" />
            <path d="M0 0H6V32H0V0Z" fill="#CDCDCD" />
            <path d="M0 26H24V32H0V26Z" fill="#CDCDCD" />
            <path d="M12 13H24V19H12V13Z" fill="#CDCDCD" />
            <path d="M18 19H24V32H18V19Z" fill="#444444" />
            <text x="34" y="23" fill="white" font-family="IBM Plex Sans, Arial, sans-serif" font-size="24" font-weight="700">
              Guai Code
            </text>
          </svg>
        </A>
