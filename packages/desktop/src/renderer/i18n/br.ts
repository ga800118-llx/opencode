export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Guai Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Guai Code foi baixada. Você gostaria de instalá-la e reiniciar?",
