export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Guai Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Guai Code er blevet downloadet. Vil du installere den og genstarte?",
