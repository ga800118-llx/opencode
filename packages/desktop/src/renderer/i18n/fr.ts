export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Guai Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Guai Code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
