export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Guai Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Guai Code er lastet ned. Vil du installere den og starte på nytt?",
