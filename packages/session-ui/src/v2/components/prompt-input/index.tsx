...
import {
  ...
  resolvePromptInputV2Copy,
  type PromptInputV2AttachmentCopy,
  type PromptInputV2Copy,
} from "./copy"
...
export type PromptInputV2Props = {
  ...
  copy?: Partial<PromptInputV2Copy>
}
          ...
          search={
            state.popover.type === "command-menu"
              ? {
                  ...
                  label: copy().commandsSearchLabel,
                  placeholder: "/",
        ...
        <div class="flex h-11 items-center gap-1 px-2 max-[480px]:h-auto max-[480px]:flex-wrap max-[480px]:py-2">
          ...
          >
            ...
            <Show when={view.agent}>
              {(control) => (
                <PromptInputV2ConfiguredSelect title={copy().chooseAgent} keybind={["Mod", "."]} control={control()} />
              )}
            </Show>
            <Show
...
export type PromptInputV2AttachmentsProps = {
...
} & PromptInputV2AttachmentCopy

export function PromptInputV2Attachments(props: PromptInputV2AttachmentsProps) {
  const copy = createMemo(() => resolvePromptInputV2AttachmentCopy(props))
  return (
            ...
            {(comment) => (
              <div class="relative group shrink-0">
                ...
                <button
                  ...
                  aria-label={copy().removeContextLabel}
                >
