...
const en = {
  "app.title": "AI Model Usage Rankings | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Guai Code Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Guai Code on GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Try Guai Code",
  ...
  "footer.homeAria": "Guai Code home",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Reading model availability and recent Guai Code usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} of recent Guai Code usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Guai Code Data",
  "model.description":
