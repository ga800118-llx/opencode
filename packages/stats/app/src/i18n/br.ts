export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo do Guai Code Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Guai Code no GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Experimente o Guai Code",
  ...
  "footer.homeAria": "Início do Guai Code",
  ...
  "modal.title": "Newsletter do Guai Code",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Guai Code.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Guai Code",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Guai Code nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Guai Code Data",
  "model.description":
