export const dict = {
  "app.title": "Ranglister for brug af AI-modeller | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Guai Code Data-ordmærke på en mørk mønstret baggrund",
  ...
  "header.githubAria": "Giv Guai Code en stjerne på GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Prøv Guai Code",
  ...
  "footer.homeAria": "Guai Code-forside",
  ...
  "modal.title": "Guai Code-nyhedsbrev",
  ...
  "lab.title": "{{lab}} AI-modelbrug og ranglister | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Læser modeltilgængelighed og seneste Guai Code-brug.",
  "lab.notFound": "Ingen modeller matchede dette lab.",
  "lab.heroPrefix": "Udforsk {{count}} {{lab}}-modeller brugt i Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} af den seneste Guai Code-brug",
  "lab.usageTitle": "{{lab}}-tokenbrug",
  "lab.usageDescription": "Daglig Guai Code-tokenvolumen over de sidste to måneder.",
  ...
  "lab.usage": "Brug",
  "lab.share": "Andel",
  "model.title": "{{model}} brug, omkostning og rang | Guai Code Data",
  "model.description":
