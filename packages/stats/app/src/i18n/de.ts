export const dict = {
  "app.title": "KI-Modellnutzungs-Rankings | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Guai Code Data-Wortmarke auf dunklem gemustertem Hintergrund",
  ...
  "header.githubAria": "Guai Code auf GitHub mit Stern markieren",
  "header.github": "GitHub",
  "header.tryOpenCode": "Guai Code ausprobieren",
  ...
  "footer.homeAria": "Guai Code-Startseite",
  ...
  "modal.title": "Guai Code-Newsletter",
  ...
  "lab.title": "{{lab}} KI-Modellnutzung und Rankings | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Modellverfügbarkeit und aktuelle Guai Code-Nutzung werden gelesen.",
  "lab.notFound": "Keine Modelle passten zu diesem Lab.",
  "lab.heroPrefix": "Erkunde {{count}} {{lab}}-Modelle, die in Guai Code verwendet werden",
  ...
  "lab.shareOfUsage": "{{share}} der aktuellen Guai Code-Nutzung",
  "lab.usageTitle": "{{lab}}-Tokennutzung",
  "lab.usageDescription": "Tägliches Guai Code-Tokenvolumen der letzten zwei Monate.",
  ...
  "lab.usage": "Nutzung",
  "lab.share": "Anteil",
  "model.title": "{{model}} Nutzung, Kosten und Rang | Guai Code Data",
  "model.description":
