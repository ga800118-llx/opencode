export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo textual de Guai Code Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Guai Code en GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Probar Guai Code",
  ...
  "footer.homeAria": "Inicio de Guai Code",
  ...
  "modal.title": "Boletín de Guai Code",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Guai Code.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Guai Code",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Guai Code durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Guai Code Data",
  "model.description":
