export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logo textuel Guai Code Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Guai Code sur GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Essayer Guai Code",
  ...
  "footer.homeAria": "Accueil Guai Code",
  ...
  "modal.title": "Newsletter Guai Code",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Guai Code.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Guai Code",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Guai Code sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Guai Code Data",
  "model.description":
