export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Logotipo Guai Code Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Guai Code su GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Prova Guai Code",
  ...
  "footer.homeAria": "Home Guai Code",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Guai Code.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Guai Code",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Guai Code negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Guai Code Data",
  "model.description":
