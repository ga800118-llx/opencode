...
export const dict = {
  ...
  "header.githubAria": "GitHubでGuai Codeにスターを付ける",
  "header.github": "GitHub",
  "header.tryOpenCode": "Guai Codeを試す",
  ...
  "lab.title": "{{lab}} AIモデル使用量とランキング | Guai Codeデータ",
  "lab.description":
    "OpenCode Goで使用されている{{lab}}モデルを、トークン使用量、モデルランキング、コンテキストウィンドウ、リリース日、コスト、モデル別データで比較できます。",
  "lab.loadingTitle": "モデルラボ",
  "lab.loadingDescription": "モデルの利用可否と最近のGuai Code使用状況を読み込んでいます。",
  "lab.notFound": "このラボに一致するモデルはありません。",
  "lab.heroPrefix": "Guai Codeで使用されている{{count}}件の{{lab}}モデルを確認",
  ...
  "lab.shareOfUsage": "最近のGuai Code使用量の{{share}}",
  "lab.usageTitle": "{{lab}}のトークン使用量",
  "lab.usageDescription": "過去2か月の日次Guai Codeトークン量。",
  ...
  "lab.usage": "使用量",
  "lab.share": "シェア",
  "model.title": "{{model}}の使用量、コスト、ランク | Guai Codeデータ",
  "model.description":
