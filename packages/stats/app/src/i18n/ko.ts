...
export const dict = {
  "app.title": "AI 모델 사용 순위 | Guai Code 데이터",
  "app.description":
    "OpenCode Go에서 AI 모델이 어떻게 사용되는지 토큰 볼륨, 순위, 시장 점유율, 토큰 가격, 세션 비용, 캐시 비율, 지역별 분포까지 살펴보세요.",
  "app.unfurlAlt": "어두운 패턴 배경 위의 Guai Code Data 워드마크",
  "nav.dataHome": "데이터 홈",
  "nav.topModels": "상위 모델",
  ...
  "header.githubAria": "GitHub에서 Guai Code에 스타 주기",
  "header.github": "GitHub",
  "header.tryOpenCode": "Guai Code 사용해 보기",
  ...
  "lab.title": "{{lab}} AI 모델 사용량 및 순위 | Guai Code 데이터",
  "lab.description":
    "OpenCode Go에서 사용되는 {{lab}} 모델을 토큰 사용량, 모델 순위, 컨텍스트 창, 출시일, 비용, 모델별 데이터까지 비교하세요.",
  "lab.loadingTitle": "모델 랩",
  "lab.loadingDescription": "모델 가용성과 최근 Guai Code 사용량을 읽는 중입니다.",
  "lab.notFound": "이 랩과 일치하는 모델이 없습니다.",
  "lab.heroPrefix": "Guai Code에서 사용된 {{count}}개의 {{lab}} 모델 살펴보기",
  ...
  "lab.shareOfUsage": "최근 Guai Code 사용량의 {{share}}",
  "lab.usageTitle": "{{lab}} 토큰 사용량",
  "lab.usageDescription": "지난 두 달 동안의 일간 Guai Code 토큰 볼륨입니다.",
  ...
  "lab.usage": "사용량",
  "lab.share": "점유율",
  "model.title": "{{model}} 사용량, 비용 및 순위 | Guai Code 데이터",
  "model.description":
