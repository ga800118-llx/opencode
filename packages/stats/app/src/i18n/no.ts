export const dict = {
  "app.title": "Rangeringer for bruk av AI-modeller | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Guai Code Data-ordmerke på en mørk mønstret bakgrunn",
  ...
  "header.githubAria": "Gi Guai Code en stjerne på GitHub",
  ...
  "modal.title": "Guai Code-nyhetsbrev",
  ...
  "lab.title": "{{lab}} AI-modellbruk og rangeringer | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Leser modelltilgjengelighet og nylig Guai Code-bruk.",
  "lab.notFound": "Ingen modeller matchet dette laben.",
  "lab.heroPrefix": "Utforsk {{count}} {{lab}}-modeller brukt i Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} av nylig Guai Code-bruk",
  "lab.usageTitle": "{{lab}} tokenbruk",
  "lab.usageDescription": "Daglig Guai Code-tokenvolum over de siste to månedene.",
  ...
  "lab.usage": "Bruk",
  "lab.share": "Andel",
  "model.title": "{{model}} bruk, kostnad og rangering | Guai Code Data",
  "model.description":
