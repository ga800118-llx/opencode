export const dict = {
  "app.title": "Rankingi użycia modeli AI | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Znak słowny Guai Code Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Guai Code na GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Wypróbuj Guai Code",
  ...
  "footer.homeAria": "Strona główna Guai Code",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Guai Code.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Guai Code",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Guai Code z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Guai Code Data",
  "model.description":
