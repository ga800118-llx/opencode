export const dict = {
  "app.title": "Рейтинги использования ИИ-моделей | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Словесный знак Guai Code Data на темном узорном фоне",
  ...
  "header.githubAria": "Поставить звезду Guai Code на GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Попробовать Guai Code",
  ...
  "footer.homeAria": "Главная Guai Code",
  ...
  "modal.title": "Рассылка Guai Code",
  ...
  "lab.title": "Использование и рейтинги ИИ-моделей {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Читаем доступность моделей и недавнее использование Guai Code.",
  "lab.notFound": "Нет моделей, соответствующих этой лаборатории.",
  "lab.heroPrefix": "Изучайте {{count}} моделей {{lab}}, используемых в Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} недавнего использования Guai Code",
  "lab.usageTitle": "Использование токенов {{lab}}",
  "lab.usageDescription": "Ежедневный объем токенов Guai Code за последние два месяца.",
  ...
  "lab.share": "Доля",
  "model.title": "Использование, стоимость и ранг {{model}} | Guai Code Data",
  "model.description":
