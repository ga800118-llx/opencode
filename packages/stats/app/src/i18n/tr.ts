export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Guai Code Data logosu",
  ...
  "header.githubAria": "GitHub'da Guai Code'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOpenCode": "Guai Code'u dene",
  ...
  "footer.homeAria": "Guai Code ana sayfası",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Model kullanılabilirliği ve son Guai Code kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Guai Code'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Guai Code kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Guai Code token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Guai Code Data",
  "model.description":
