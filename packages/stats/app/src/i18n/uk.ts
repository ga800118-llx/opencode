export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | Guai Code Data",
  "app.description":
  ...
  "app.unfurlAlt": "Словесний знак Guai Code Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку Guai Code на GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Спробувати Guai Code",
  ...
  "footer.homeAria": "Головна Guai Code",
  ...
  "modal.title": "Розсилка Guai Code",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | Guai Code Data",
  "lab.description":
  ...
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання Guai Code.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в Guai Code",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання Guai Code",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів Guai Code за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | Guai Code Data",
  "model.description":
