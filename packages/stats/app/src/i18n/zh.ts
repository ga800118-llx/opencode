...
export const dict = {
  ...
  "header.githubAria": "在 GitHub 上为 Guai Code 加星",
  "header.github": "GitHub",
  "header.tryOpenCode": "试用 Guai Code",
  "header.openNav": "打开导航",
  ...
  "lab.title": "{{lab}} AI 模型使用量与排名 | Guai Code 数据",
  "lab.description":
    "比较在 OpenCode Go 中使用的 {{lab}} 模型，包括 token 用量、模型排名、上下文窗口、发布日期、成本和模型专属数据。",
  "lab.loadingTitle": "模型实验室",
  "lab.loadingDescription": "正在读取模型可用性和近期 Guai Code 使用情况。",
  "lab.notFound": "没有匹配此实验室的模型。",
  "lab.heroPrefix": "探索 Guai Code 中使用的 {{count}} 个 {{lab}} 模型",
  ...
  "lab.shareOfUsage": "占近期 Guai Code 使用量的 {{share}}",
  "lab.usageTitle": "{{lab}} token 用量",
  "lab.usageDescription": "过去两个月的每日 Guai Code token 用量。",
  ...
  "lab.usage": "用量",
  "lab.share": "份额",
  "model.title": "{{model}} 使用量、成本与排名 | Guai Code 数据",
  "model.description":
