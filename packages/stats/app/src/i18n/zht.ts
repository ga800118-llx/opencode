...
export const dict = {
  ...
  "header.githubAria": "在 GitHub 上為 Guai Code 加星",
  "header.github": "GitHub",
  "header.tryOpenCode": "試用 Guai Code",
  "header.openNav": "開啟導覽",
  ...
  "lab.title": "{{lab}} AI 模型使用量與排名 | Guai Code 數據",
  "lab.description":
    "比較在 OpenCode Go 中使用的 {{lab}} 模型，包括 token 用量、模型排名、上下文視窗、發布日期、成本和模型專屬數據。",
  "lab.loadingTitle": "模型實驗室",
  "lab.loadingDescription": "正在讀取模型可用性和近期 Guai Code 使用情況。",
  "lab.notFound": "沒有符合此實驗室的模型。",
  "lab.heroPrefix": "探索 Guai Code 中使用的 {{count}} 個 {{lab}} 模型",
  ...
  "lab.shareOfUsage": "佔近期 Guai Code 使用量的 {{share}}",
  "lab.usageTitle": "{{lab}} token 用量",
  "lab.usageDescription": "過去兩個月的每日 Guai Code token 用量。",
  ...
  "lab.usage": "用量",
  "lab.share": "佔比",
  "model.title": "{{model}} 使用量、成本與排名 | Guai Code 數據",
  "model.description":
