...
export const dict = {
  ...
  "ui.sessionTurn.process.processing": "處理中 {{duration}}",
  "ui.sessionTurn.process.elapsed": "耗時 {{duration}}",
  "ui.sessionTurn.process.slow": "回應較慢，仍在等待",
  "ui.sessionTurn.process.unverified": "暫時無法確認活動，工作仍在繼續",
