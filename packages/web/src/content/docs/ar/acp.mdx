---
title: دعم ACP
description: استخدم Guai Code في أي محرر متوافق مع ACP.
---

يدعم Guai Code بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Guai Code عبر ACP، اضبط محررك ليشغّل الأمر `opencode acp`.

يشغّل هذا الأمر Guai Code كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Guai Code' من محدد الوكلاء في AI Chat.
...
لاستخدام Guai Code كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Guai Code كوكيل ACP للدردشة.
...
يعمل Guai Code عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Guai Code
