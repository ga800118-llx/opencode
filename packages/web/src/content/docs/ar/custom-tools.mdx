...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في Guai Code.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في Guai Code مثل `read` و`write` و`bash`.
