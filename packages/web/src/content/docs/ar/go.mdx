...
يعمل Go مثل أي مزود آخر في Guai Code. تشترك في OpenCode Go وتحصل على مفتاح API الخاص بك. وهو **اختياري تمامًا**، ولا تحتاج إلى استخدامه لاستخدام Guai Code.
...
:::tip
اختبرنا مجموعة مختارة من النماذج والمزودين الذين يعملون جيدًا مع Guai Code.
:::
...
يعمل OpenCode Go مثل أي مزود آخر في Guai Code.
...
يستخدم [model id](/docs/config/#models) في إعدادات Guai Code لديك التنسيق `opencode-go/<model-id>`. على سبيل المثال، بالنسبة إلى Kimi K3، ستستخدم `opencode-go/kimi-k3` في إعداداتك.
...
4. **عدم فرض قيود ارتباط** من خلال السماح لك أيضًا باستخدام أي مزود آخر مع Guai Code.
