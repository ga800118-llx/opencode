---
title: خوادم LSP
description: يتكامل Guai Code مع خوادم LSP لديك.
---

يمكن أن يتكامل Guai Code مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Guai Code مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح Guai Code لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات Guai Code.
