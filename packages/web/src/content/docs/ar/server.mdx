---
title: الخادم
description: تفاعل مع خادم Guai Code عبر HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

يشغّل الأمر `opencode serve` خادما HTTP دون واجهة ويعرض نقطة نهاية OpenAPI يمكن لعميل Guai Code استخدامها.
...
:::tip
استخدم خادم Guai Code للتفاعل مع Guai Code برمجيا.
:::

تتيح هذه البنية لـ Guai Code دعم عدة عملاء وتمكّنك من التفاعل مع Guai Code برمجيا.

يمكنك تشغيل `opencode serve` لبدء خادم مستقل. إذا كانت واجهة Guai Code في terminal (TUI)
...
يمكن استخدام نقطة النهاية [`/tui`](#tui) للتحكم في الـ TUI عبر الخادم. على سبيل المثال، يمكنك تعبئة الموجّه مسبقا أو تشغيله. يُستخدم هذا الإعداد بواسطة ملحقات Guai Code لـ [IDE](/docs/ide).
...
يعرض خادم Guai Code واجهات API التالية.
