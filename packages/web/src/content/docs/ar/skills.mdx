...
تتيح مهارات الوكيل لـ Guai Code اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج Guai Code صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض Guai Code المهارات المتاحة في وصف أداة `skill`.
