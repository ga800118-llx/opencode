...
مع Guai Code يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Guai Code سمتنا `opencode`.
...
يأتي Guai Code مع عدة سمات مدمجة.
...
- يريدون أن يطابق Guai Code مظهر terminal لديهم
...
يدعم Guai Code نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
