---
title: TUI
description: استخدام واجهة المستخدم TUI في Guai Code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Guai Code واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Guai Code إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Guai Code في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Guai Code. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Guai Code. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار Guai Code بعد الضغط على leader key. القيمة الافتراضية `2000`.
