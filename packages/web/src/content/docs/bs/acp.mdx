---
title: ACP podrška
description: Koristite Guai Code u bilo kojem uređivaču kompatibilnom sa ACP.
---

Guai Code podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Guai Code putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `opencode acp`.

Naredba pokreće Guai Code kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Guai Code" agenta u AI Chat agent selektoru.
...
Da koristite Guai Code kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Guai Code kao ACP chat agenta.
...
Guai Code radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Guai Code konfiguraciji
