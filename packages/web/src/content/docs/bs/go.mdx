...
Go radi kao bilo koji drugi provajder u Guai Code-u. Pretplatite se na OpenCode Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Guai Code.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Guai Code-om.
:::
...
OpenCode Go radi kao bilo koji drugi provajder u Guai Code-u.
...
[Model id](/docs/config/#models) u vašoj Guai Code konfiguraciji
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Guai Code koristite i bilo kojeg drugog provajdera.
