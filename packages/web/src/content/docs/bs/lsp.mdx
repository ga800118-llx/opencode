---
title: LSP serveri
description: Guai Code se integriše sa vašim LSP serverima.
---

Guai Code se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Guai Code dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i Guai Code otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj Guai Code konfiguraciji.
