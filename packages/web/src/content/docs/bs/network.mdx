...
Guai Code podržava standardne proxy varijable okruženja i prilagođene certifikate za enterprise mrežna okruženja.

## Proksi

Guai Code poštuje standardne varijable proxy okruženja.
...
Ako vaše preduzeće koristi prilagođene CA-ove za HTTPS veze, konfigurirajte Guai Code da im vjeruje.
