---
title: Dodaci
description: Napišite vlastite dodatke za proširenje Guai Code.
---

Dodaci vam omogućavaju da proširite Guai Code spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja Guai Code.
...
Guai Code pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje Guai Code.
...
Spriječite Guai Code da čita `.env` fajlove:
...
Dodaci također mogu dodati prilagođene alate u Guai Code:
...
Pomoćnik `tool` kreira prilagođeni alat koji Guai Code može pozvati. Uzima funkciju Zod sheme i vraća definiciju alata sa:

- `description`: Šta alat radi
- `args`: Zod šema za argumente alata
- `execute`: Funkcija koja se pokreće kada se pozove alat
  Vaši prilagođeni alati će biti dostupni za Guai Code zajedno sa ugrađenim alatima.
