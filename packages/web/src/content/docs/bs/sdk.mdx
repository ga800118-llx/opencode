---
title: SDK
description: Type-safe JS klijent za Guai Code server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Guai Code JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
...
Ako vec imate pokrenutu Guai Code instancu, mozete napraviti klijentsku instancu i povezati se na nju:
