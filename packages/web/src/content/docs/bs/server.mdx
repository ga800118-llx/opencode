---
title: Server
description: Komunicirajte s Guai Code serverom preko HTTP-a.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Komanda `opencode serve` pokrece headless HTTP server koji izlaže OpenAPI endpoint koji Guai Code klijent moze koristiti.
...
:::tip
Koristite Guai Code server za programsku interakciju sa opencode-om.
:::

Ova arhitektura omogucava Guai Code podrsku za vise klijenata i programsku interakciju.

Mozete pokrenuti `opencode serve` da startate standalone server. Ako je Guai Code TUI vec pokrenut, `opencode serve` ce pokrenuti novi server.
...
Endpoint [`/tui`](#tui) mozete koristiti za upravljanje TUI-jem kroz server. Na primjer, mozete unaprijed popuniti ili pokrenuti prompt. Ovaj setup koriste Guai Code [IDE](/docs/ide) pluginovi.
...
Guai Code server izlaže sljedece API-je.
