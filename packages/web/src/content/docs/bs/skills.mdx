...
Agent skills omogucavaju Guai Code da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Guai Code pretrazuje ove lokacije:
...
Za projektne lokalne putanje, Guai Code ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Guai Code navodi dostupne skills u opisu `skill` alata.
