...
U Guai Code mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Guai Code koristi nasu `opencode` temu.
...
Guai Code dolazi sa vise ugradenih tema.
...
- Zele da Guai Code odgovara izgledu njihovog terminala
...
Guai Code podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
