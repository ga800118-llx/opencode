---
title: TUI
description: Korištenje korisničkog interfejsa Guai Code terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Guai Code pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Guai Code pokreće TUI za trenutni direktorij.
...
Kada koristite Guai Code TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Guai Code. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Guai Code. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo Guai Code čeka nakon leader key. Podrazumijevano je `2000`.
