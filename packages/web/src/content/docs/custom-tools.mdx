---
title: Custom Tools
description: Create tools the LLM can call in Guai Code.
---

Custom tools are functions you create that the LLM can call during conversations. They work alongside Guai Code's [built-in tools](/docs/tools) like `read`, `write`, and `bash`.
