...
Du kan tilføje brugerdefinerede kommandoer gennem Guai Code-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Guai Code [config](/docs/config):
