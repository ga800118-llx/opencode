...
Go fungerer som enhver anden udbyder i Guai Code. Du abonnerer på OpenCode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Guai Code.
:::
...
OpenCode Go fungerer som enhver anden udbyder i Guai Code.
...
Dit [model id](/docs/config/#models) i din Guai Code config
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Guai Code.
