---
title: LSP-servere
description: Guai Code integreres med dine LSP-servere.
---

Guai Code kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Guai Code leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og Guai Code åbner en fil, vil den:
