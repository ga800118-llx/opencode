---
title: Udbydere
description: Brug en hvilken som helst LLM-udbyder i Guai Code.
---

import config from "../../../../config.mjs"
export const console = config.console

Guai Code bruger [AI SDK](https://ai-sdk.dev/) og [Models.dev](https://models.dev) til at understøtte **75+ LLM-udbydere** og understøtter kørsel af lokale modeller.
...
OpenCode Zen er en liste over modeller leveret af OpenCode-teamet, som er blevet testet og verificeret til at fungere godt med Guai Code. [Læs mere](/docs/zen).
...
Det fungerer som alle andre udbydere i Guai Code og er helt valgfrit at bruge.

---

## OpenCode Go

OpenCode Go er en billig abonnementsplan, der giver pålidelig adgang til populære åbne kodningsmodeller leveret af OpenCode-teamet, som er testet og verificeret til at fungere godt med Guai Code.
...
Sådan bruger du Amazon Bedrock med Guai Code:
...
2. **Konfigurer godkendelse** ved at bruge en af følgende metoder:
   ...
   Angiv en af disse miljøvariabler, mens du kører Guai Code:
...
:::info
At bruge dit Claude Pro/Max-abonnement i Guai Code understøttes ikke officielt af [Anthropic](https://anthropic.com).
:::
...
Du kan konfigurere Guai Code til at bruge lokale modeller via [Atomic Chat](https://atomic.chat) — en desktopapplikation, der kører lokale LLM'er bag en OpenAI-kompatibel API-server (standard-endpoint `http://127.0.0.1:1337/v1`).
...
2. Gå til [Azure AI Foundry](https://ai.azure.com/) og distribuer en model.
   ...
   :::note
   Distributionsnavnet skal matche modelnavnet for at Guai Code skal fungere korrekt.
   :::
...
gemme tokenet i Guai Code auth-lagring.
:::

##### Selvhostet GitLab

:::note[overholdelsesbemærkning]
Guai Code bruger en lille model til nogle AI-opgaver som at generere sessionstitlen.
Den er konfigureret til at bruge gpt-5-nano som standard, hostet af Zen. For at låse Guai Code
...
Sådan bruger du GitHub Copilot-abonnementet med Guai Code:
...
Sådan bruger du Google Vertex AI med Guai Code:
...
2. Angiv de nødvendige miljøvariabler:
   ...
   Sæt dem mens du kører Guai Code.
...
I tilfælde af at du ser en funktion eller model fra Helicone som ikke konfigureres automatisk gennem Guai Code, kan du altid konfigurere den selv.
...
Du kan konfigurere Guai Code til at bruge lokale modeller gennem [llama.cpps](https://github.com/ggml-org/llama.cpp) llama-server-værktøj
...
Du kan konfigurere Guai Code til at bruge lokale modeller gennem LM Studio.
...
Du kan konfigurere Guai Code til at bruge lokale modeller gennem Ollama.

:::tip
Ollama kan automatisk konfigurere sig selv for Guai Code. Se [Ollama-integrationsdokumenterne](https://docs.ollama.com/integrations/opencode) for detaljer.
:::
...
Sådan bruger du Ollama Cloud med Guai Code:
...
3. Kopier API-nøglen til brug i Guai Code.
...
6. **Vigtigt**: Før du bruger skymodeller i Guai Code, skal du hente modelinformationen lokalt:
...
Sådan bruger du [Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/) med Guai Code:
...
:::tip
Du kan bruge hvilken som helst OpenAI-kompatibel udbyder med Guai Code. De fleste moderne AI-udbydere tilbyder OpenAI-kompatible API'er.
:::
...
`limit`-felterne lader Guai Code forstå hvor meget kontekst du har tilbage. Standardudbydere henter disse automatisk fra models.dev.
