...
Brug den til at bygge integrasjoner og kontrollere Guai Code programmatisk.
...
Opret en forekomst av Guai Code:
...
Hvis du allerede har en kjørende forekomst av Guai Code, kan du oprete en klientforekomst for at koble til den:
