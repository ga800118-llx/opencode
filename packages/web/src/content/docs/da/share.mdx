...
Guai Codes delingsfunksjon lar deg lage offentlige lenker til dine opencode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Guai Code:
...
Guai Code støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger Guai Code manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
[Finn ut mer](/docs/enterprise) om brug av Guai Code i organisasjonen din.
