---
title: Deling
description: Del dine Guai Code-samtaler.
---

Guai Codes delingsfunksjon lar deg lage offentlige lenker til dine Guai Code-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
