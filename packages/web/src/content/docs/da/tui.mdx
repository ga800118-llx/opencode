---
title: TUI
description: Brug af Guai Code-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Guai Code giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Guai Code starter TUI for den nuværende mappe.
...
Når du bruger Guai Code TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Guai Code. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Guai Code. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe Guai Code venter efter leader key. Standard er `2000`.
