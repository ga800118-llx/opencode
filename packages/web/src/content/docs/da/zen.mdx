...
Zen fungerer som enhver anden udbyder i Guai Code. Du logger ind på OpenCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Guai Code.
:::
...
OpenCode Zen fungerer som enhver anden udbyder i Guai Code.
...
[model id](/docs/config/#models) i din Guai Code-konfiguration
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. Guai Code bruger disse modeller til at generere sessionstitler.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Guai Code også.
