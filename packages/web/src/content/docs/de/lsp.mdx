---
title: LSP Server
description: Guai Code lässt sich in Ihren LSP-Server integrieren.
---

Guai Code kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Guai Code verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Guai Code eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Guai Code-Konfiguration aktivieren und anpassen.
