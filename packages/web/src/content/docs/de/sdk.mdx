---
title: SDK
description: Typsicherer JS-Client fuer den Guai Code-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das Guai Code JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und Guai Code programmatisch steuern.
...
Erstelle eine Guai Code-Instanz:
...
Wenn Guai Code bereits laeuft, kannst du nur einen Client erstellen und verbinden:
