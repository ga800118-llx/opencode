---
title: Server
description: Nutze den Guai Code-Server ueber HTTP.
---
...
Er stellt einen OpenAPI-Endpunkt bereit, den ein Guai Code-Client nutzen kann.
...
:::tip
Nutze den Guai Code-Server, um Guai Code programmatisch anzusteuern.
:::
...
Dieses Muster nutzen auch die Guai Code-[IDE](/docs/ide)-Plugins.
...
Der Guai Code-Server stellt folgende APIs bereit.
