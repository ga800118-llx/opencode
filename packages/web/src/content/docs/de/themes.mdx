...
Mit Guai Code kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Guai Code das `opencode`-Theme.
...
Guai Code liefert mehrere eingebaute Themes mit.
...
- Guai Code optisch ans Terminal anpassen wollen
...
Guai Code unterstuetzt ein flexibles JSON-basiertes Theme-System.
