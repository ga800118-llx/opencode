---
title: TUI
description: Arbeite mit Guai Code in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Guai Code bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Guai Code die TUI im aktuellen Verzeichnis.
...
In der Guai Code-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Guai Code hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Guai Code. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange Guai Code nach der leader key wartet. Standard ist `2000`.
