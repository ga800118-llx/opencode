---
title: Web
description: Verwenden Sie Guai Code in Ihrem Browser.
---

Guai Code kann als Webanwendung in Ihrem Browser ausgeführt werden und bietet das gleiche leistungsstarke KI-Codierungserlebnis, ohne dass ein Terminal erforderlich ist.

![Guai Code Web – Neue Sitzung](../../../assets/web/web-homepage-new-session.png)
...
Dadurch wird ein lokaler Server auf `127.0.0.1` mit einem zufällig verfügbaren Port gestartet und Guai Code automatisch in Ihrem Standardbrowser geöffnet.
...
Standardmäßig wählt Guai Code einen verfügbaren Port aus. Sie können einen Port angeben:
...
Standardmäßig bindet der Server an `127.0.0.1` (nur localhost). So machen Sie Guai Code in Ihrem Netzwerk zugänglich:

```bash
opencode web --hostname 0.0.0.0
```

Bei Verwendung von `0.0.0.0` zeigt Guai Code sowohl lokale als auch Netzwerkadressen an:
...
Nach dem Start bietet die Weboberfläche Zugriff auf Ihre Guai Code-Sitzungen.

### Sitzungen

Zeigen Sie Ihre Sitzungen auf der Startseite an und verwalten Sie sie. Sie können aktive Sitzungen sehen und neue starten.

![Guai Code Web – Aktive Sitzung](../../../assets/web/web-homepage-active-session.png)

### Serverstatus

Klicken Sie auf „Server anzeigen“, um verbundene Server und deren Status anzuzeigen.

![Guai Code Web – Siehe Server](../../../assets/web/web-homepage-see-servers.png)
