---
title: Ecosystem
description: Projects and integrations built with Guai Code.
---

A collection of community projects built on Guai Code.

:::note
Want to add your Guai Code related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                        |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Guai Code sessions in isolated Daytona sandboxes with git sync and live previews  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Guai Code usage with Wakatime                                                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Guai Code sessions                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Guai Code context                               |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Guai Code agents to lazy load prompts on demand with skill discovery and injection            |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend Guai Code /commands into a powerful orchestration system with granular flow control          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Guai Code – know when tasks complete                                    |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Guai Code                                                           |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Guai Code sessions, built on the SDK       |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Guai Code plugins                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for Guai Code - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Guai Code via @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Guai Code             |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Guai Code in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Guai Code |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Guai Code extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Guai Code          |
