...
Puede agregar comandos personalizados a través de la configuración Guai Code o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Guai Code [config](/docs/config):
...
Guai Code incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
