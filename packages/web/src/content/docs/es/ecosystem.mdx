---
title: Ecosistema
description: Proyectos e integraciones construidas con Guai Code.
---

Una colección de proyectos comunitarios construidos en Guai Code.

:::note
¿Quieres agregar tu proyecto relacionado con Guai Code a esta lista? Envíe un PR.
:::
...
| Nombre                                                                                             | Descripción                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones Guai Code en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Seguimiento del uso de Guai Code con Wakatime                                                                                |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificaciones de escritorio y alertas sonoras para sesiones Guai Code                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto Guai Code                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permitir que los agentes Guai Code carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Amplíe Guai Code /commands a un potente sistema de orquestación con control de flujo granular                                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificaciones nativas del sistema operativo para Guai Code: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Árboles de trabajo de Git de fricción cero para Guai Code                                                                    |
...
| Nombre                                                                                     | Descripción                                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones Guai Code, basado en el SDK                    |
...
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para Guai Code a través de Tailscale/VPN                |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos Guai Code                                           |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Interfaz de Neovim para Guai Code: un agente de codificación de IA basado en terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar Guai Code a través de @opencode-ai/sdk              |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para Guai Code                       |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Complemento de Obsidian que incorpora Guai Code en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por Guai Code            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones Guai Code con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para Guai Code               |
