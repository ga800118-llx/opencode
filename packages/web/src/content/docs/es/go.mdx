...
Go funciona como cualquier otro proveedor en Guai Code. Te suscribes a OpenCode Go y
...
OpenCode Go funciona como cualquier otro proveedor en Guai Code.
...
El [ID del modelo](/docs/config/#models) en tu configuración de Guai Code
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con Guai Code.
