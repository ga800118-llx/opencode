...
description: Guai Code se integra con sus servidores LSP.
---

Guai Code puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Guai Code viene con varios servidores LSP integrados para idiomas populares:
...
Cuando LSP está habilitado y Guai Code abre un archivo:
...
Puede habilitar y personalizar los servidores LSP a través de la sección `lsp` en su configuración Guai Code.
