...
Los proveedores más populares están precargados de forma predeterminada. Si agregó las credenciales de un proveedor mediante el comando `/connect`, estarán disponibles cuando inicie Guai Code.
...
Aqui tienes varios modelos que funcionan bien con Guai Code, sin orden particular. (Esta no es una lista exhaustiva ni necesariamente actualizada):
...
Muchos modelos admiten múltiples variantes con diferentes configuraciones. Guai Code se envía con variantes predeterminadas integradas para proveedores populares.

### Variantes integradas

Guai Code se envía con variantes predeterminadas para muchos proveedores:
...
Cuando se inicia Guai Code, busca modelos en el siguiente orden de prioridad:
...
2. La lista de modelos en la configuración Guai Code.
