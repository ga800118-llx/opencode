---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor Guai Code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK Guai Code JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar Guai Code mediante programación.
...
Cree una instancia de Guai Code:
...
Si ya tiene una instancia en ejecución de Guai Code, puede crear una instancia de cliente para conectarse a ella:
