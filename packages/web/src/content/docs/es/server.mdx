---
title: Servidor
description: Interactuar con el servidor Guai Code a través de HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El comando `opencode serve` ejecuta un servidor HTTP sin cabeza que expone un punto final OpenAPI que un cliente Guai Code puede usar.
...
:::tip
Utilice el servidor Guai Code para interactuar con Guai Code mediante programación.
:::

Esta arquitectura permite que Guai Code admita múltiples clientes y le permite interactuar con Guai Code mediante programación.

Puede ejecutar `opencode serve` para iniciar un servidor independiente. Si tienes el
Guai Code TUI ejecutándose, `opencode serve` iniciará un nuevo servidor.
...
El punto final [`/tui`](#tui) se puede utilizar para conducir el TUI a través del servidor. Por ejemplo, puede completar previamente o ejecutar un mensaje. Esta configuración es utilizada por los complementos Guai Code [IDE](/docs/ide).
...
El servidor Guai Code expone las siguientes API.
