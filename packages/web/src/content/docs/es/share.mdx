---
title: Compartir
description: Comparte tus conversaciones Guai Code.
---

La función para compartir de Guai Code te permite crear enlaces públicos a tus conversaciones de Guai Code, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Guai Code:
...
Guai Code admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Guai Code usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
[Obtenga más información](/docs/enterprise) sobre el uso de Guai Code en su organización.
