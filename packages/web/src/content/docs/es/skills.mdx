...
Las habilidades del agente permiten a Guai Code descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Guai Code busca estas ubicaciones:
...
Para las rutas locales del proyecto, Guai Code sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Guai Code enumera las habilidades disponibles en la descripción de la herramienta `skill`.
