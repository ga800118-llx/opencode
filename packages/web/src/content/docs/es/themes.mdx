...
Con Guai Code puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Guai Code usa nuestro propio tema `opencode`.
...
Guai Code viene con varios temas integrados.
...
- Quiere que Guai Code coincida con la apariencia de su terminal
...
Guai Code admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
