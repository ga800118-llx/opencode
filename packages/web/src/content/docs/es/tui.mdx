---
title: TUI
description: Usando la interfaz de usuario del terminal Guai Code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Guai Code proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Guai Code se inicia TUI para el directorio actual.
...
Cuando utilice Guai Code TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Guai Code. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Guai Code. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera Guai Code después de la leader key. El valor predeterminado es `2000`.
