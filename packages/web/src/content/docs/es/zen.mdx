...
Zen funciona como cualquier otro proveedor en Guai Code. Inicias sesión en OpenCode Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Guai Code.
:::
...
OpenCode Zen funciona como cualquier otro proveedor en Guai Code.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Guai Code
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Guai Code usa estos modelos para generar títulos de sesiones.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Guai Code.
