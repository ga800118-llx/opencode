...
description: Créez des outils que le LLM peut appeler dans Guai Code.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de Guai Code comme `read`, `write` et `bash`.
