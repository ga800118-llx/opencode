---
title: SDK
description: Client JS de type sécurisé pour le serveur Guai Code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Le SDK Guai Code JS/TS fournit un client de type sécurisé pour interagir avec le serveur.
Utilisez-le pour créer des intégrations et contrôler Guai Code par programme.
...
Créez une instance de Guai Code :
...
Si vous disposez déjà d'une instance en cours d'exécution de Guai Code, vous pouvez créer une instance client pour vous y connecter :
