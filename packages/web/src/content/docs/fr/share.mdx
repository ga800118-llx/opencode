---
title: Partager
description: Partagez vos conversations Guai Code.
---

La fonctionnalité de partage de Guai Code vous permet de créer des liens publics vers vos conversations Guai Code, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
Lorsque vous partagez une conversation, Guai Code :
...
Guai Code prend en charge trois modes de partage qui contrôlent la manière dont les conversations sont partagées :

---

### Manuel (par défaut)

Par défaut, Guai Code utilise le mode de partage manuel. Les sessions ne sont pas partagées automatiquement, mais vous pouvez les partager manuellement à l'aide de la commande `/share` :
...
[En savoir plus](/docs/enterprise) sur l'utilisation de Guai Code dans votre organisation.
