...
Les compétences d'agent permettent à Guai Code de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Guai Code recherche ces emplacements :
...
Pour les chemins locaux du projet, Guai Code remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Guai Code répertorie les compétences disponibles dans la description de l'outil `skill`.
