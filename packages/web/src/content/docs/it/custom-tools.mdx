...
description: Crea strumenti che l'LLM puo chiamare in Guai Code.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di Guai Code come `read`, `write` e `bash`.
