---
title: Server LSP
description: Guai Code si integra con i tuoi server LSP.
---

Guai Code può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Guai Code include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e Guai Code apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di Guai Code.
