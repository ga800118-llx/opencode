---
title: SDK
description: Client JS type-safe per il server Guai Code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di Guai Code fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare Guai Code in modo programmatico.
...
Se hai gia un'istanza di Guai Code in esecuzione, puoi creare un client per collegarti:
