---
title: Condivisione
description: Condividi le tue conversazioni Guai Code.
---

La funzione di condivisione di Guai Code ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Guai Code:
...
Guai Code supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Guai Code usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
[Scopri di piu](/docs/enterprise) su come usare Guai Code nella tua organizzazione.
