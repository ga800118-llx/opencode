...
Le skill degli agenti permettono a Guai Code di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Guai Code cerca in queste posizioni:
...
Per i percorsi locali al progetto, Guai Code risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Guai Code elenca le skill disponibili nella descrizione dello strumento `skill`.
