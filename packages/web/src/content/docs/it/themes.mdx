...
Con Guai Code puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, Guai Code usa il tema `opencode`.
...
Guai Code include diversi temi integrati.
...
- Vuole che Guai Code corrisponda all'aspetto del terminale
...
Guai Code supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
