...
Zen funziona come qualsiasi altro provider in Guai Code. Accedi a OpenCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Guai Code.
:::
...
OpenCode Zen funziona come qualsiasi altro provider in Guai Code.
...
Il [model id](/docs/config/#models) nella config di Guai Code
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Guai Code usa questi modelli per generare i titoli delle sessioni.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Guai Code.
