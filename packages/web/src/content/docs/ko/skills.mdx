...
Agent Skill let Guai Code discover reusable instruction from your repo 또는 홈 디렉토리.
...
Project-local paths의 경우, Guai Code는 git worktree에 도달 할 때까지 현재 작업 디렉토리에서 걷습니다.
...
Guai Code는 `skill` 도구 설명에서 사용할 수있는 기술을 나열합니다.
