---
title: Web
description: 브라우저에서 Guai Code 사용하기.
---

Guai Code는 브라우저에서 웹 응용 프로그램을 실행할 수 있으며 terminal을 필요로하지 않고 동일한 강력한 AI 코딩 경험을 제공합니다.

![Guai Code Web - 새로운 세션](../../../assets/web/web-homepage-new-session.png)
...
`127.0.0.1`의 로컬 서버를 랜덤 사용 가능한 포트로 시작하고 기본 브라우저에서 Guai Code를 자동으로 엽니다.
...
기본적으로 Guai Code는 사용할 수 있는 포트를 선택합니다. 포트를 지정할 수 있습니다:
...
기본적으로 서버는 `127.0.0.1` (localhost only)에 바인딩합니다. 네트워크에서 Guai Code를 사용할 수 있도록:

```bash
opencode web --hostname 0.0.0.0
```

`0.0.0.0`를 사용할 때, Guai Code는 로컬 및 네트워크 주소를 모두 표시합니다.
...
시작되면 웹 인터페이스는 Guai Code 세션에 액세스 할 수 있습니다.
...
![Guai Code Web - Servers 참조](../../../assets/web/web-homepage-see-servers.png)
