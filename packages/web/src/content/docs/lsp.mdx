---
title: LSP Servers
description: Guai Code integrates with your LSP servers.
---

Guai Code can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Guai Code comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and Guai Code opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your Guai Code config.
