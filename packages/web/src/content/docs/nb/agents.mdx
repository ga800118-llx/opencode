...
Det er to typer agenter i Guai Code; primære agenter og underagenter.
...
Guai Code kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Guai Code kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Guai Code kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Hvis ingen temperatur er spesifisert, bruker Guai Code modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Guai Code-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Guai Code-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [OpenCode Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
