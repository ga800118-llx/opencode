...
Du kan legge til egendefinerte kommandoer gjennom Guai Code-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Guai Code [config](/docs/config):
...
Guai Code inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
