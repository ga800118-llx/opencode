...
description: Lag verktøy som LLM kan kalle inn Guai Code.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Guai Code sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
