---
title: IDE
description: Guai Code-utvidelsen for VS Code, Cursor og andre IDE-er
---

Guai Code integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `opencode` i terminalen for å komme i gang.

---

## Bruk

- **Hurtigstart**: Bruk `Cmd+Esc` (Mac) eller `Ctrl+Esc` (Windows/Linux) for å åpne Guai Code i en delt terminalvisning, eller fokuser en eksisterende terminaløkt hvis en allerede kjører.
- **Ny økt**: Bruk `Cmd+Shift+Esc` (Mac) eller `Ctrl+Shift+Esc` (Windows/Linux) for å starte en ny Guai Code-terminaløkt, selv om en allerede er åpen. Du kan også klikke på Guai Code-knappen i UI.
- **Kontekstbevissthet**: Del automatisk ditt nåværende valg eller fane med Guai Code.
...
For å installere Guai Code på VS Code og populære varianter som Cursor, Windsurf, VSCodium:
...
Søk etter **Guai Code** i Extension Marketplace og klikk på **Install**.
