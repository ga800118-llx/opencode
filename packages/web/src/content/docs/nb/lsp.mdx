---
title: LSP-servere
description: Guai Code integreres med LSP-serverne dine.
---

Guai Code kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Guai Code kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og Guai Code åpner en fil, gjør den:
