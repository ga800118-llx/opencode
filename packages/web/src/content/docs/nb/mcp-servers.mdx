...
MCP-ene dine er tilgjengelige som verktøy i Guai Code, sammen med innebygde verktøy. Så du kan administrere dem gjennom opencode-konfigurasjonen som alle andre verktøy.
