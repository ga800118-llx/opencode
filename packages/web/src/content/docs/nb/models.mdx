...
De fleste populære leverandørene er forhåndslastet som standard. Hvis du har lagt til legitimasjonen for en leverandør gjennom kommandoen `/connect`, vil den være tilgjengelig når du starter Guai Code.
...
Her er flere modeller som fungerer godt med Guai Code, uten spesiell rekkefølge. (Dette er ikke en uttømmende liste og er heller ikke nødvendigvis oppdatert):
...
Mange modeller støtter flere varianter med forskjellige konfigurasjoner. Guai Code leveres med innebygde standardvarianter for populære leverandører.

### Innebygde varianter

Guai Code leveres med standardvarianter for mange leverandører:
...
Når Guai Code starter opp, ser den etter modeller i følgende prioriterte rekkefølge:
