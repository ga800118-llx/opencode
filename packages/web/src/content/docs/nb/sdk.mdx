---
title: SDK
description: Typesikker JS-klient for Guai Code-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Guai Code JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Guai Code programmatisk.
...
Opprett en forekomst av Guai Code:
...
Hvis du allerede har en kjørende forekomst av Guai Code, kan du opprette en klientforekomst for å koble til den:
