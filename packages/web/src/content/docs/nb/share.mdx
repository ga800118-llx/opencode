...
Delingsfunksjonen i Guai Code lar deg lage offentlige lenker til dine opencode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker Guai Code manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
[Finn ut mer](/docs/enterprise) om bruk av Guai Code i organisasjonen din.
