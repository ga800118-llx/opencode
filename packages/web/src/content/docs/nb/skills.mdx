...
Agentferdigheter lar Guai Code oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Guai Code søker etter disse stedene:
...
For prosjektlokale stier går Guai Code opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
Guai Code viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
