---
title: Web
description: Bruke Guai Code i nettleseren din.
---

Guai Code kan kjøres som en nettapplikasjon i nettleseren din, og gir den samme kraftige AI-kodingsopplevelsen uten at du trenger en terminal.

![Guai Code Web - Ny økt](../../../assets/web/web-homepage-new-session.png)
...
Dette starter en lokal server på `127.0.0.1` med en tilfeldig tilgjengelig port og åpner automatisk Guai Code i standard nettleser.
...
Som standard velger Guai Code en tilgjengelig port. Du kan spesifisere en port:
...
Som standard binder serveren seg til `127.0.0.1` (kun localhost). Slik gjør du Guai Code tilgjengelig på nettverket ditt:
...
Når den er startet, gir nettgrensesnittet tilgang til dine Guai Code-økter.
