...
Zen fungerer som enhver annen leverandør i Guai Code. Du logger inn på OpenCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Guai Code.
:::
...
OpenCode Zen fungerer som enhver annen leverandør i Guai Code.
...
[modell-id](/docs/config/#models) i Guai Code-konfigurasjonen din
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Guai Code bruker disse modellene til å generere økttitler.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Guai Code også.
