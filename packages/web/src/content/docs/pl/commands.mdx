...
Użyj opcji `command` w swojej konfiguracji Guai Code:
...
Guai Code zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
