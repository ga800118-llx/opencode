...
Go działa jak każdy inny dostawca w Guai Code. Subskrybujesz OpenCode Go i
...
OpenCode Go działa jak każdy inny dostawca w Guai Code.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Guai Code
...
4. Zapewnić **brak ograniczeń (no lock-in)**, pozwalając na korzystanie z dowolnego innego dostawcy wraz z Guai Code.
