---
title: IDE
description: Rozszerzenie Guai Code dla VS Code, Cursor i innych IDE
---

Guai Code integruje się z VS Code, Cursorem lub obsługującym terminal IDE. Aby uruchomić, po prostu uruchom `opencode` w terminalu.

---

## Stosowanie

- **Szybkie uruchomienie**: użycie `Cmd+Esc` (Mac) lub `Ctrl+Esc` (Windows/Linux), aby uruchomić Guai Code w uruchamianiu terminala lub skoncentruj się na uruchamianiu terminala, jeśli jest już uruchomiony.
- **Nowa sesja**: `Cmd+Shift+Esc` (Mac) lub `Ctrl+Shift+Esc` (Windows/Linux), aby została nowa konfiguracja terminala Guai Code, nawet jeśli jest już otwarta. Możesz także kliknąć przycisk Guai Code w interfejsie użytkownika.
- **Świadomość kontekstu**: Automatycznie udostępnia wybór lub kartę za pomocą Guai Code.
...
Aby poznać Guai Code na VS Code w forkach, takich jak Cursor, Windsurf, VSCodium:
...
Wyszukaj **Guai Code** na rynku rozszerzonym i kliknij **Zainstaluj**.
