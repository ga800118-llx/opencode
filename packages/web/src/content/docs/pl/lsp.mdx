---
title: Serwery LSP
description: Guai Code integruje się z serwerami LSP.
---

Guai Code może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

Guai Code posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i Guai Code otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji Guai Code.
