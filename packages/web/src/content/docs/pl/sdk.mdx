---
title: SDK
description: Typowany klient JS dla serwera Guai Code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS Guai Code zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli Guai Code.
...
Jeśli masz już działającą instancję Guai Code, możesz utworzyć instancję klienta, aby się z nią połączyć:
