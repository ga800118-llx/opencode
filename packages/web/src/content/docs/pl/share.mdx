---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące Guai Code.
---

Funkcja udostępniania Guai Code umożliwia tworzenie publicznych linków do konwersacji Guai Code, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, Guai Code:
...
Guai Code obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie Guai Code korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
[Dowiedz się więcej](/docs/enterprise) o używaniu Guai Code w Twojej organizacji.
