...
Umiejętności agenta pozwalają Guai Code odkryć instrukcje wielokrotnego użytku z repozytorium lub katalogu domowego.
...
Guai Code przeszukuje te lokalizacje:
...
W przypadku ścieżek lokalnych projektu Guai Code przechodzi od bieżącego katalogu roboczego, aż dotrze do drzewa roboczego git.
...
Guai Code wymienia dostępne umiejętności w opisie narzędzia `skill`.
