...
Dzięki Guai Code możesz wybrać jeden z kilku wbudowanych motywów, użyć motywu, który dostosowuje się do motywu terminala lub zdefiniować własny, niestandardowy motyw.

Domyślnie Guai Code używa naszego własnego motywu `opencode`.
...
Guai Code ma kilka wbudowanych motywów.
...
- Chcą, aby Guai Code pasował do wyglądu ich terminala
...
Guai Code obsługuje elastyczny system motywów oparty na JSON, który pozwala użytkownikom łatwo tworzyć i dostosowywać motywy.
