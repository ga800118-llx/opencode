---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala Guai Code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Guai Code zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie Guai Code uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI Guai Code, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do Guai Code. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij Guai Code. _Aliasy_: `/quit`, `/q`
...
- `leader_timeout` - Określa, jak długo Guai Code czeka po naciśnięciu leader key. Domyślnie `2000`.
