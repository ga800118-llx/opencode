...
Zen działa jak każdy inny dostawca w Guai Code. Logujesz się do OpenCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Guai Code.
:::
...
OpenCode Zen działa jak każdy inny dostawca w Guai Code.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Guai Code używa formatu
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Guai Code używa tych modeli do generowania tytułów sesji.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Guai Code także dowolnego innego dostawcy.
