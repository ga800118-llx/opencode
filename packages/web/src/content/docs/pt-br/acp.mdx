---
title: Suporte ACP
description: Use o Guai Code em qualquer editor compatível com ACP.
---

O Guai Code suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar Guai Code via ACP, configure seu editor para executar o comando `opencode acp`.

Este comando inicia o Guai Code como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'Guai Code' no seletor de agentes do AI Chat.
...
Para usar Guai Code como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar Guai Code como o agente ACP para chat.
...
O Guai Code funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do Guai Code
