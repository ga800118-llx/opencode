...
description: Crie ferramentas que o LLM pode chamar no Guai Code.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do Guai Code, como `read`, `write` e `bash`.
