---
title: Ecossistema
description: Projetos e integrações construídos com o Guai Code.
---

Uma coleção de projetos da comunidade construídos sobre o Guai Code.

:::note
Quer adicionar seu projeto relacionado ao Guai Code a esta lista? Envie um PR.
:::
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do Guai Code em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do Guai Code com Wakatime                                                                                       |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do Guai Code                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do Guai Code                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do Guai Code carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estenda Guai Code /commands em um poderoso sistema de orquestração com controle de fluxo granular                               |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para Guai Code – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para Guai Code                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do Guai Code, construído sobre o SDK       |
...
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para Guai Code sobre Tailscale/VPN                           |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do Guai Code                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim para Guai Code - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar Guai Code via @opencode-ai/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para Guai Code                    |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora Guai Code na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo Guai Code     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões Guai Code com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para Guai Code                  |
