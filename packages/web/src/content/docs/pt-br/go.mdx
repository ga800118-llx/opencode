...
O Go funciona como qualquer outro provedor no Guai Code. Você assina o OpenCode Go e
...
O OpenCode Go funciona como qualquer outro provedor no Guai Code.
...
O [ID do modelo](/docs/config/#models) na sua configuração do Guai Code
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o Guai Code também.
