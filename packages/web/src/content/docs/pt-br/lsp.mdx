...
description: O Guai Code integra-se aos seus servidores LSP.
---

O Guai Code pode se integrar a servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para o agente.

---

## Integrados

O Guai Code vem com vários servidores LSP integrados para linguagens populares:
...
Quando o LSP está habilitado e o Guai Code abre um arquivo, ele:
...
Você pode habilitar e personalizar os servidores LSP através da seção `lsp` na sua configuração do Guai Code.
