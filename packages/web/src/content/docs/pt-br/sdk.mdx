---
title: SDK
description: Cliente JS seguro em tipos para o servidor Guai Code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do Guai Code fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o Guai Code programaticamente.
...
Crie uma instância do Guai Code:
...
Se você já tem uma instância do Guai Code em execução, pode criar uma instância de cliente para se conectar a ela:
