---
title: Servidor
description: Interaja com o servidor Guai Code via HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O comando `opencode serve` executa um servidor HTTP sem cabeça que expõe um endpoint OpenAPI que um cliente Guai Code pode usar.
...
:::tip
Use o servidor Guai Code para interagir com o Guai Code programaticamente.
:::

Essa arquitetura permite que o Guai Code suporte múltiplos clientes e permite que você interaja com o Guai Code programaticamente.

Você pode executar `opencode serve` para iniciar um servidor autônomo. Se você tiver o TUI do Guai Code em execução, `opencode serve` iniciará um novo servidor.
...
O endpoint [`/tui`](#tui) pode ser usado para controlar o TUI através do servidor. Por exemplo, você pode preencher ou executar um prompt. Essa configuração é usada pelos plugins do Guai Code [IDE](/docs/ide).
...
O servidor Guai Code expõe as seguintes APIs.
