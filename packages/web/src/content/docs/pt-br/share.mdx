---
title: Compartilhar
description: Compartilhe suas conversas do Guai Code.
---

O recurso de compartilhamento do Guai Code permite que você crie links públicos para suas conversas do Guai Code, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o Guai Code:
...
O Guai Code suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o Guai Code usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
[Saiba mais](/docs/enterprise) sobre como usar o Guai Code em sua organização.
