...
As habilidades do agente permitem que o Guai Code descubra instruções reutilizáveis do seu repositório ou diretório pessoal.
...
O Guai Code pesquisa nesses locais:
...
Para caminhos locais do projeto, o Guai Code sobe a partir do seu diretório de trabalho atual até alcançar a árvore de trabalho do git.
...
O Guai Code lista as habilidades disponíveis na descrição da ferramenta `skill`.
