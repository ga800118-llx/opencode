...
Com o Guai Code, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.

Por padrão, o Guai Code usa nosso próprio tema `opencode`.
...
O Guai Code vem com vários temas embutidos.
...
- Querem que o Guai Code corresponda à aparência do seu terminal
...
O Guai Code suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
