---
title: TUI
description: Usando a interface de usuário de terminal Guai Code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O Guai Code fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar Guai Code inicia o TUI para o diretório atual.
...
Ao usar o TUI do Guai Code, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao Guai Code. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do Guai Code. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Controla por quanto tempo o Guai Code espera depois da leader key. O padrão é `2000`.
