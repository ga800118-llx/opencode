---
title: SDK
description: Типобезопасный JS-клиент для сервера Guai Code.
---
...
Если у вас уже есть работающий экземпляр Guai Code, вы можете создать экземпляр клиента для подключения к нему:
