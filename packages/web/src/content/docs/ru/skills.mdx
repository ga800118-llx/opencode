...
Навыки агента позволяют Guai Code обнаруживать многократно используемые инструкции из вашего репозитория или домашнего каталога.
...
Guai Code выполняет поиск в следующих местах:
...
Для локальных путей проекта Guai Code переходит из вашего текущего рабочего каталога, пока не достигнет рабочего дерева git.
...
Guai Code перечисляет доступные навыки в описании инструмента `skill`.
