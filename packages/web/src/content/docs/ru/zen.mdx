...
Zen работает как любой другой провайдер в Guai Code. Вы входите в OpenCode Zen и получаете
свой ключ API. Это **полностью необязательно**, и вам не нужно использовать его,
чтобы пользоваться Guai Code.
...
:::tip
Мы протестировали выбранную группу моделей и провайдеров, которые хорошо работают с Guai Code.
:::
...
OpenCode Zen работает как любой другой провайдер в Guai Code.
...
[идентификатор модели](/docs/config/#models) в вашей конфигурации Guai Code
...
В истории использования могут появляться [недорогие модели](/docs/config/#models), такие как Haiku, Nano или Flash. Guai Code использует эти модели для создания заголовков сессий.
...
4. Обеспечить **отсутствие привязки**, позволяя вам использовать его с любым другим агентом для программирования. И всегда позволять вам использовать любого другого провайдера с Guai Code.
