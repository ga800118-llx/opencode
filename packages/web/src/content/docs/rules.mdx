...
You can provide custom instructions to Guai Code by creating an `AGENTS.md` file. This is similar to Cursor's rules. It contains instructions that will be included in the LLM's context to customize its behavior for your specific project.

---

## Initialize

To create a new `AGENTS.md` file, you can run the `/init` command in Guai Code.
...
Guai Code also supports reading the `AGENTS.md` file from multiple locations. And this serves different purposes.
...
You can also have global rules in a `~/.config/opencode/AGENTS.md` file. This gets applied across all Guai Code sessions.

Since this isn't committed to Git or shared with your team, we recommend using this to specify any personal rules that the LLM should follow.

### Claude Code Compatibility

For users migrating from Claude Code, Guai Code supports Claude Code's file conventions as fallbacks:
...
When Guai Code starts, it looks for rule files in this order:
...
While Guai Code doesn't automatically parse file references in `AGENTS.md`, you can achieve similar functionality in two ways:
...
You can teach Guai Code to read external files by providing explicit instructions in your `AGENTS.md`. Here's a practical example:
...
- Ensure Guai Code loads files only when needed for the specific task
