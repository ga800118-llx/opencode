---
title: SDK
description: Type-safe JS client for Guai Code server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The Guai Code JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control Guai Code programmatically.
...
Create an instance of Guai Code:
...
If you already have a running instance of Guai Code, you can create a client instance to connect to it:
