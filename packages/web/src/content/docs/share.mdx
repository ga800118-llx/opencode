---
title: Share
description: Share your Guai Code conversations.
---

Guai Code's share feature allows you to create public links to your Guai Code conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Guai Code:
...
Guai Code supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Guai Code uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using Guai Code in your organization.
