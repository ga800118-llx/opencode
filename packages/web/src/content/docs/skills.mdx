...
Agent skills let Guai Code discover reusable instructions from your repo or home directory.
...
Guai Code searches these locations:
...
For project-local paths, Guai Code walks up from your current working directory until it reaches the git worktree.
...
Guai Code lists available skills in the `skill` tool description.
