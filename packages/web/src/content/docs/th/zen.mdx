...
Zen ทำงานเหมือน provider อื่น ๆ ใน Guai Code คุณล็อกอินเข้า OpenCode Zen แล้วรับ
...
:::tip
เราได้ทดสอบโมเดลและ provider ที่คัดมาแล้วกลุ่มหนึ่งซึ่งทำงานได้ดีกับ Guai Code
:::
...
OpenCode Zen ทำงานเหมือน provider อื่น ๆ ใน Guai Code
...
[model id](/docs/config/#models) ใน Guai Code config ของคุณใช้รูปแบบ `opencode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `opencode/gpt-5.5` ใน config ของคุณ
...
คุณอาจสังเกตเห็น[โมเดลต้นทุนต่ำ](/docs/config/#models) เช่น Haiku, Nano หรือ Flash ในประวัติการใช้งานของคุณ Guai Code ใช้โมเดลเหล่านี้เพื่อสร้างชื่อเซสชัน
...
4. ทำให้เกิด **no lock-in** โดยให้คุณใช้มันร่วมกับ coding agent อื่น ๆ ได้ และยังเปิดให้คุณใช้ provider อื่น ๆ กับ Guai Code ได้เสมอ
