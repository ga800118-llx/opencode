---
title: Ekosistem
description: Guai Code ile geliştirilen projeler ve entegrasyonlar.
---

Guai Code üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
Guai Code ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Guai Code oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile Guai Code kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Guai Code oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Guai Code bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Guai Code aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Guai Code /commands komutlarını, ayrıntılı akış kontrolü ile güçlü bir orkestrasyon sistemine genişletin                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Guai Code için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Guai Code için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, Guai Code oturumlarını kontrol eden Discord botu       |
...
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden Guai Code için mobil öncelikli web arayüzü               |
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Guai Code eklentileri oluşturmak için şablon                                     |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Guai Code için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla Guai Code kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Guai Code için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Guai Code'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Guai Code tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip Guai Code eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Guai Code için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
