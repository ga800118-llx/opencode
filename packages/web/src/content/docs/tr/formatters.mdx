...
description: Guai Code dile özgü biçimlendiriciler kullanır.
---

Guai Code, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

Guai Code, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, Guai Code bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

Guai Code bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri Guai Code yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
