...
description: Guai Code, LSP sunucularınızla bütünleşir.
---

Guai Code, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Guai Code, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP etkinleştirildiğinde ve Guai Code bir dosyayı açtığında:
...
LSP sunucularını, Guai Code yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
