---
title: SDK
description: Guai Code sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Guai Code JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
Guai Code'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir Guai Code örneği oluşturun:
...
Halihazırda çalışan bir Guai Code örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
