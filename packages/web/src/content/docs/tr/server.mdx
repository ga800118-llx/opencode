---
title: Sunucu
description: Guai Code sunucusuyla HTTP uzerinden etkilesin.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

`opencode serve` komutu, Guai Code istemcisinin kullanabileceği bir OpenAPI endpoint'i açan headless bir HTTP sunucusu çalıştırır.
...
:::tip
Guai Code ile programatik etkileşim için Guai Code sunucusunu kullanın.
:::

Bu mimari, Guai Code'un birden fazla istemciyi desteklemesini ve programatik kullanımları mümkün kılmasını sağlar.

`opencode serve` ile bağımsız bir sunucu başlatabilirsiniz. Guai Code TUI açıksa, `opencode serve` yeni bir sunucu başlatır.
...
[`/tui`](#tui) uç noktası sunucu üzerinden TUI'yi sürmek için kullanılabilir. Örneğin bir istemi önceden doldurabilir veya çalıştırabilirsiniz. Bu kurulum Guai Code [IDE](/docs/ide) eklentileri tarafından kullanılır.
...
Guai Code sunucusu aşağıdaki API'leri sunar.
